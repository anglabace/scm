...
@Repository
public class ApInvoiceListViewDao extends HibernateDao<ArInvoiceListView,Integer>{
...
//	}
	...
	public  List<ApInvoiceListView> list(Map m){
		List<ApInvoiceListView> list = null;
		String hql = "select a.* from accounting.v_ap_invoice_list a, accounting.ap_invoices b, accounting.ap_transactions c where a.currency = c.currency  and b.vendor_no = c.vendor_no and a.invoice_id=b.invoice_id ";
