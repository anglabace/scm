 ...
 *         &lt;element name="withShipTo" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "GetByCustID")
public class GetByCustID {
    ...
    /**
     * Gets the value of the withShipTo property.
     * 
     */
    public boolean isWithShipTo() {
        return withShipTo;
    }

    /**
     * Sets the value of the withShipTo property.
     * 
     */
    public void setWithShipTo(boolean value) {
        this.withShipTo = value;
    }
