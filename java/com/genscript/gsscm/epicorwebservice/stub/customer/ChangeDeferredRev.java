 ...
 *         &lt;element name="ipDeferredRev" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "ChangeDeferredRev")
public class ChangeDeferredRev {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected boolean ipDeferredRev;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the ipDeferredRev property.
     * 
     */
    public boolean isIpDeferredRev() {
        return ipDeferredRev;
    }

    /**
     * Sets the value of the ipDeferredRev property.
     * 
     */
    public void setIpDeferredRev(boolean value) {
        this.ipDeferredRev = value;
    }
