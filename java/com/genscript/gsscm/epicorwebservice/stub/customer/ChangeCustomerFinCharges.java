 ...
 *         &lt;element name="ipFinCharges" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "ChangeCustomerFinCharges")
public class ChangeCustomerFinCharges {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected boolean ipFinCharges;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the ipFinCharges property.
     * 
     */
    public boolean isIpFinCharges() {
        return ipFinCharges;
    }

    /**
     * Sets the value of the ipFinCharges property.
     * 
     */
    public void setIpFinCharges(boolean value) {
        this.ipFinCharges = value;
    }
