 ...
 *         &lt;element name="proposedICTrader" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "ChgICTrader")
public class ChgICTrader {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected boolean proposedICTrader;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the proposedICTrader property.
     * 
     */
    public boolean isProposedICTrader() {
        return proposedICTrader;
    }

    /**
     * Sets the value of the proposedICTrader property.
     * 
     */
    public void setProposedICTrader(boolean value) {
        this.proposedICTrader = value;
    }
