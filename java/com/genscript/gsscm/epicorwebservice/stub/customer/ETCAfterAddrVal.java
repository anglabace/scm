 ...
 *         &lt;element name="ds1" type="{http://epicor.com/schemas}ETCAddrValidationDataSetType" minOccurs="0"/>
...
@XmlRootElement(name = "ETCAfterAddrVal")
public class ETCAfterAddrVal {
    ...
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected ETCAddrValidationDataSetType ds1;
    @XmlElement(namespace = "http://epicor.com/webservices/")
     ...
     *     
     */
    public ETCAddrValidationDataSetType getDs1() {
        return ds1;
    }
     ...
     *     
     */
    public void setDs1(ETCAddrValidationDataSetType value) {
        this.ds1 = value;
    }
