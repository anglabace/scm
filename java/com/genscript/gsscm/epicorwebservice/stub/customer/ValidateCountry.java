 ...
 *         &lt;element name="ipProposedCountry" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
public class ValidateCountry {
    ...
    /**
     * Gets the value of the ipProposedCountry property.
     * 
     */
    public int getIpProposedCountry() {
        return ipProposedCountry;
    }

    /**
     * Sets the value of the ipProposedCountry property.
     * 
     */
    public void setIpProposedCountry(int value) {
        this.ipProposedCountry = value;
    }
