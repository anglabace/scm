 ...
 *         &lt;element name="newQtyBearing" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "ChangeQtyBearing")
public class ChangeQtyBearing {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected boolean newQtyBearing;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the newQtyBearing property.
     * 
     */
    public boolean isNewQtyBearing() {
        return newQtyBearing;
    }

    /**
     * Sets the value of the newQtyBearing property.
     * 
     */
    public void setNewQtyBearing(boolean value) {
        this.newQtyBearing = value;
    }
