 ...
 *         &lt;element name="ipBuyToOrder" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "ChangePartPlantBuyToOrder")
public class ChangePartPlantBuyToOrder {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected boolean ipBuyToOrder;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the ipBuyToOrder property.
     * 
     */
    public boolean isIpBuyToOrder() {
        return ipBuyToOrder;
    }

    /**
     * Sets the value of the ipBuyToOrder property.
     * 
     */
    public void setIpBuyToOrder(boolean value) {
        this.ipBuyToOrder = value;
    }
