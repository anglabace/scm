 ...
 *         &lt;element name="proposedGlobalPart" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "ChangePartGlobalPart")
public class ChangePartGlobalPart {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected boolean proposedGlobalPart;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the proposedGlobalPart property.
     * 
     */
    public boolean isProposedGlobalPart() {
        return proposedGlobalPart;
    }

    /**
     * Sets the value of the proposedGlobalPart property.
     * 
     */
    public void setProposedGlobalPart(boolean value) {
        this.proposedGlobalPart = value;
    }
