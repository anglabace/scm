 ...
 *         &lt;element name="ipConvOverrride" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "ChangePartUOMConvOverride")
public class ChangePartUOMConvOverride {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected boolean ipConvOverrride;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the ipConvOverrride property.
     * 
     */
    public boolean isIpConvOverrride() {
        return ipConvOverrride;
    }

    /**
     * Sets the value of the ipConvOverrride property.
     * 
     */
    public void setIpConvOverrride(boolean value) {
        this.ipConvOverrride = value;
    }
