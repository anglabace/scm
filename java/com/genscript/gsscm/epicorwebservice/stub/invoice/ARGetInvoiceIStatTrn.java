 ...
 *         &lt;element name="inInvoiceNum" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlRootElement(name = "ARGetInvoiceIStatTrn")
public class ARGetInvoiceIStatTrn {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected int inInvoiceNum;
    @XmlElement(namespace = "http://epicor.com/webservices/")
     ...
     * 
     */
    public void setInInvoiceNum(int value) {
