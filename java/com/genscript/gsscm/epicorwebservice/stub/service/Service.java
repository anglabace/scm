...
@WebServiceClient(name = "Service", 
                  wsdlLocation = "http://10.168.2.131/EpicorServices/service.asmx?wsdl",
...
public class Service extends javax.xml.ws.Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://10.168.2.131/EpicorServices/service.asmx?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:http://10.168.2.131/EpicorServices/service.asmx?wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
