 ...
 *         &lt;element name="proposedERSOrder" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "ChangeERSOrder")
public class ChangeERSOrder {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected boolean proposedERSOrder;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the proposedERSOrder property.
     * 
     */
    public boolean isProposedERSOrder() {
        return proposedERSOrder;
    }

    /**
     * Sets the value of the proposedERSOrder property.
     * 
     */
    public void setProposedERSOrder(boolean value) {
        this.proposedERSOrder = value;
    }
