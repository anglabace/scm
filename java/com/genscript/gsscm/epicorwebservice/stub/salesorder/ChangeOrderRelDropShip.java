 ...
 *         &lt;element name="ipDropShip" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "ChangeOrderRelDropShip")
public class ChangeOrderRelDropShip {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected boolean ipDropShip;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the ipDropShip property.
     * 
     */
    public boolean isIpDropShip() {
        return ipDropShip;
    }

    /**
     * Sets the value of the ipDropShip property.
     * 
     */
    public void setIpDropShip(boolean value) {
        this.ipDropShip = value;
    }
