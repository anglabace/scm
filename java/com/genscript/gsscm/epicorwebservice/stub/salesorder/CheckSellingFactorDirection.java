 ...
 *         &lt;element name="ipSellingFactorDirection" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "CheckSellingFactorDirection")
public class CheckSellingFactorDirection {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected String ipSellingFactorDirection;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the ipSellingFactorDirection property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getIpSellingFactorDirection() {
        return ipSellingFactorDirection;
    }

    /**
     * Sets the value of the ipSellingFactorDirection property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setIpSellingFactorDirection(String value) {
        this.ipSellingFactorDirection = value;
    }
