 ...
 *         &lt;element name="ipCreditCardOrder" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "OnChangeCreditCardOrder")
public class OnChangeCreditCardOrder {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected boolean ipCreditCardOrder;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the ipCreditCardOrder property.
     * 
     */
    public boolean isIpCreditCardOrder() {
        return ipCreditCardOrder;
    }

    /**
     * Sets the value of the ipCreditCardOrder property.
     * 
     */
    public void setIpCreditCardOrder(boolean value) {
        this.ipCreditCardOrder = value;
    }
