 ...
 *         &lt;element name="proposedSONum" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlRootElement(name = "CheckSONum")
public class CheckSONum {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected int proposedSONum;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the proposedSONum property.
     * 
     */
    public int getProposedSONum() {
        return proposedSONum;
    }

    /**
     * Sets the value of the proposedSONum property.
     * 
     */
    public void setProposedSONum(int value) {
        this.proposedSONum = value;
    }
