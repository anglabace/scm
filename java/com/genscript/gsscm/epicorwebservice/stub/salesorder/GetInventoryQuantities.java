 ...
 *         &lt;element name="lOnlyRel" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "GetInventoryQuantities")
public class GetInventoryQuantities {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected boolean lOnlyRel;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the lOnlyRel property.
     * 
     */
    public boolean isLOnlyRel() {
        return lOnlyRel;
    }

    /**
     * Sets the value of the lOnlyRel property.
     * 
     */
    public void setLOnlyRel(boolean value) {
        this.lOnlyRel = value;
    }
