 ...
 *         &lt;element name="newBillToConNum" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlRootElement(name = "OnChangeofBTConNum")
public class OnChangeofBTConNum {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected int newBillToConNum;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the newBillToConNum property.
     * 
     */
    public int getNewBillToConNum() {
        return newBillToConNum;
    }

    /**
     * Sets the value of the newBillToConNum property.
     * 
     */
    public void setNewBillToConNum(int value) {
        this.newBillToConNum = value;
    }
