 ...
 *         &lt;element name="newTaxAmt" type="{http://www.w3.org/2001/XMLSchema}decimal"/>
...
@XmlRootElement(name = "OnChangeOfTaxAmt")
public class OnChangeOfTaxAmt {
    ...
    protected BigDecimal newTaxAmt;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the newTaxAmt property.
     * 
     * @return
     *     possible object is
     *     {@link BigDecimal }
    ...
    /**
     * Sets the value of the newTaxAmt property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigDecimal }
     *     
     */
    public void setNewTaxAmt(BigDecimal value) {
        this.newTaxAmt = value;
    }
