 ...
 *         &lt;element name="SalesOrderData" type="{http://epicor.com/schemas}SalesOrderDataSetType" minOccurs="0"/>
...
public class Update {
    ...
    @XmlElement(name = "SalesOrderData", namespace = "http://epicor.com/webservices/")
