 ...
 *         &lt;element name="ipExpMonth" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *         &lt;element name="ipExpYear" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlRootElement(name = "ChangeCreditExp")
public class ChangeCreditExp {

    @XmlElement(name = "CompanyID", namespace = "http://epicor.com/webservices/")
    protected String companyID;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected int ipExpMonth;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    protected int ipExpYear;
    @XmlElement(namespace = "http://epicor.com/webservices/")
    ...
    /**
     * Gets the value of the ipExpMonth property.
     * 
     */
    public int getIpExpMonth() {
        return ipExpMonth;
    }

    /**
     * Sets the value of the ipExpMonth property.
     * 
     */
    public void setIpExpMonth(int value) {
        this.ipExpMonth = value;
    }

    /**
     * Gets the value of the ipExpYear property.
     * 
     */
    public int getIpExpYear() {
        return ipExpYear;
    }

    /**
     * Sets the value of the ipExpYear property.
     * 
     */
    public void setIpExpYear(int value) {
        this.ipExpYear = value;
    }
