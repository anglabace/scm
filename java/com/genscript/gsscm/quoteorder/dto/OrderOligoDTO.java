 ...
 *
 */
@XmlType(name = "OrderOligoDTO", namespace = WsConstants.NS)
public class OrderOligoDTO extends BaseEntity {
	...
	private String	 	aliquotingSize;
	
	public OrderOligoDTO() {
		super();
	}
	...
	public String getAliquotingSize() {
		return aliquotingSize;
	}
	public void setAliquotingSize(String aliquotingSize) {
