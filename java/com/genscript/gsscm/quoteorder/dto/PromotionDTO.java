...
@XmlType(name = "PromotionDTO", namespace = WsConstants.NS)
public class PromotionDTO {
	...
	public Double getOrderTotalMin1() {
		return orderTotalMin1;
	}
	public void setOrderTotalMin1(Double orderTotalMin1) {
