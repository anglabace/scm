...
@Entity
@Table(name = "product_peptide_modification", catalog = "olddb")
public class ProductPeptideModification implements Serializable {
	/**
		 * 
		 */
	private static final long serialVersionUID = -7320496016888757867L;
	@Id
