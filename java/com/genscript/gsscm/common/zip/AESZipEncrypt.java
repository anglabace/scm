...
/**
 * 采取AES算法对文件加密/解密和压缩/解压缩对象类
 * @author 丁腾飞
 * @date 2010/11/18
 * @version 1.0.0
 */
public class AESZipEncrypt {
	...
	public static void main(String args[]) throws Exception {
		...
		new AESZipEncrypt().encryptZip("e:/com", "e:/comXXX/page.zip",
				"e:/comXXX/public.key");

		System.out.println(System.currentTimeMillis() - a);
		a = System.currentTimeMillis();

		new AESZipEncrypt().decryptUnzip("e:/comXXX/page.zip", "e:/comxxx",
				"e:/comXXX/public.key");
		System.out.println(System.currentTimeMillis() - a);
	}
}
