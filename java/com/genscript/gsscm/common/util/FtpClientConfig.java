...
public final class FtpClientConfig {
	...
	private static Logger logger = LoggerFactory.getLogger(FtpClientConfig.class);
	...
	private void initConfig() throws Exception{
		setServer("10.168.2.131");
		setPort("21");
		setUsername("Administrator");
		setPassword("M29p8521");
		setFTPStyle("unix");
		setLocalEncoding("GBK");
		setRemoteEncoding("GBK");
		setPassiveMode("true");
		setBinaryFileType("true");
		setRootPath("/");
