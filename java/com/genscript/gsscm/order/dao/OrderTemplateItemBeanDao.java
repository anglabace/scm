...
@Repository
public class OrderTemplateItemBeanDao extends HibernateDao<OrderTemplateItemBean, Integer>{

	public Page<OrderTemplateItemBean> findPage(final Page<OrderTemplateItemBean> page,final List<PropertyFilter> filterList,List<String> catalogNoList){
