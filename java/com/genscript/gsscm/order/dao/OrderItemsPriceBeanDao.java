...
@Repository
public class OrderItemsPriceBeanDao extends HibernateDao<OrderItemsPriceBean, Integer> {
	public Page<OrderItemsPriceBean> findPage(final Page<OrderItemsPriceBean> page,final List<PropertyFilter> filterList,List<String> catalogNoList){
