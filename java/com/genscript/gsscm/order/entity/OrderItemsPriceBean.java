...
@Entity
@Table(name = "v_cust_product_price_of_order", catalog="order")
public class OrderItemsPriceBean implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2246642937421079599L;
	@Id
