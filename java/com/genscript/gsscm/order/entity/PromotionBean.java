...
@Entity
@Table(name = "v_all_promotions", catalog="order")
public class PromotionBean implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1204836334641837579L;
	@Id
	...
	public String getRfmValueCd() {
		return rfmValueCd;
	}
	public void setRfmValueCd(String rfmValueCd) {
		this.rfmValueCd = rfmValueCd;
	}
	public String getOrderSourceCd() {
		return orderSourceCd;
	}
