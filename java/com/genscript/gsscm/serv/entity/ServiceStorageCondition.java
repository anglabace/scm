 ...
 */
@Entity
@Table(name = "service_storage_condition", catalog="product")
@XmlType(name = "ServiceStorageCondition", namespace = WsConstants.NS)
public class ServiceStorageCondition extends BaseEntity{
