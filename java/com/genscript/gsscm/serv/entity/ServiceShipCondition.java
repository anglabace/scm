 ...
 */
@Entity
@Table(name = "service_ship_condition", catalog = "product")
@XmlType(name = "ServiceShipCondition", namespace = WsConstants.NS)
public class ServiceShipCondition extends BaseEntity {
	...
	/**
	 * @param specShipCharge
	 *            the specShipCharge to set
	 */
	...
	/**
	 * @param shipExemptFlag
	 *            the shipExemptFlag to set
	 */
	...
	/**
	 * @param intlShipWeight
	 *            the intlShipWeight to set
	 */
