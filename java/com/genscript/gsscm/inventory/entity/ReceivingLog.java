...
public class ReceivingLog implements java.io.Serializable {
	...
	/** minimal constructor */
	public ReceivingLog(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public ReceivingLog(Integer id, String orderType, String trackingNo,
