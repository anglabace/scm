...
@Repository
public class QuoteItemsPriceBeanDao extends HibernateDao<QuoteItemsPriceBean, Integer> {
	public Page<QuoteItemsPriceBean> findPage(final Page<QuoteItemsPriceBean> page,final List<PropertyFilter> filterList,List<String> catalogNoList){
