...
@XmlType(name = "QuotePackageDTO", namespace = WsConstants.NS)
public class QuotePackageDTO {
	...
	private List<QuotePackageItemDTO> packageItemList;
	
	
	public List<QuotePackageItemDTO> getPackageItemList() {
		return packageItemList;
	}
	public void setPackageItemList(List<QuotePackageItemDTO> packageItemList) {
