...
public class Localization  implements java.io.Serializable {
    ...
    /* Identifies the locale (i.e. country code) associated with the
     * language. */
     ...
     * 
     * @return languageCode   * Identifies the language to use for human-readable messages.
     */
     ...
     * 
     * @param languageCode   * Identifies the language to use for human-readable messages.
     */
     ...
     * 
     * @return localeCode   * Identifies the locale (i.e. country code) associated with the
     * language.
     */
     ...
     * 
     * @param localeCode   * Identifies the locale (i.e. country code) associated with the
     * language.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "Localization"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("languageCode");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "LanguageCode"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("localeCode");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "LocaleCode"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
