...
public class VariableHandlingChargeDetail  implements java.io.Serializable {
     ...
     * the reply. */
    private com.fedex.ship.stub.VariableHandlingChargeType variableHandlingChargeType;

    /* Used with Variable handling charge type of FIXED_VALUE.
     * 														Contains the amount to be added to the freight charge.
     * 														Contains 2 explicit decimal positions with a total max
     * length of 10 including the decimal. */
    private com.fedex.ship.stub.Money fixedValue;

    /* Used with Variable handling charge types PERCENTAGE_OF_BASE,
     * PERCENTAGE_OF_NET or PERCETAGE_OF_NET_EXCL_TAXES.
     * 														Used to calculate the amount to be added to the freight
     * charge.
    ...
    public VariableHandlingChargeDetail(
           com.fedex.ship.stub.VariableHandlingChargeType variableHandlingChargeType,
     ...
     * the reply.
     */
    public com.fedex.ship.stub.VariableHandlingChargeType getVariableHandlingChargeType() {
     ...
     * the reply.
     */
    public void setVariableHandlingChargeType(com.fedex.ship.stub.VariableHandlingChargeType variableHandlingChargeType) {
        this.variableHandlingChargeType = variableHandlingChargeType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "VariableHandlingChargeDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("variableHandlingChargeType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "VariableHandlingChargeType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "VariableHandlingChargeType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("fixedValue");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "FixedValue"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "PercentValue"));
