...
public class SmartPostShipmentDetail  implements java.io.Serializable {
    ...
    private com.fedex.ship.stub.SmartPostShipmentSpecialServiceType[] specialServices;
     ...
     * not have multiple trailers this field can be omitted. If however you
     * 							have multiple trailers a manifest Id must be assigned to each
     * Smart Post package determined by the trailer it is being loaded onto.
     * The manifest Id must be unique to your account number for a minimum
     * of 6 months
     * 							and cannot exceed 8 characters in length. We recommend you
     * use the day of year + the trailer id (this could simply be a sequential
     * number for that trailer). So if you had 3 trailers that you started
     * loading on Feb 10
     * 							the 3 manifest ids would be 041001, 041002, 041003 (in this
     * case we used leading zeros on the trailer numbers). */
    ...
    public SmartPostShipmentDetail(
           ...
           com.fedex.ship.stub.SmartPostShipmentSpecialServiceType[] specialServices,
     ...
     */
    public com.fedex.ship.stub.SmartPostShipmentSpecialServiceType[] getSpecialServices() {
        return specialServices;
    }
     ...
     */
    public void setSpecialServices(com.fedex.ship.stub.SmartPostShipmentSpecialServiceType[] specialServices) {
        this.specialServices = specialServices;
    }

    public com.fedex.ship.stub.SmartPostShipmentSpecialServiceType getSpecialServices(int i) {
        return this.specialServices[i];
    }

    public void setSpecialServices(int i, com.fedex.ship.stub.SmartPostShipmentSpecialServiceType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "SmartPostShipmentDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("indicia");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "Indicia"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "SmartPostIndiciaType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("ancillaryEndorsement");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "AncillaryEndorsement"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "SmartPostAncillaryEndorsementType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("specialServices");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "SpecialServices"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "SmartPostShipmentSpecialServiceType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "HubId"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "CustomerManifestId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
