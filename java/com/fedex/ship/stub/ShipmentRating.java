...
public class ShipmentRating  implements java.io.Serializable {
    /* Identifies which entry in the ShipmentRateDetails array is
     * considered as presenting the actual rates for the shipment. */
    private com.fedex.ship.stub.ReturnedRateType actualRateType;

    /* The difference between account based rates and list rates.
     * Only returned when list rates are requested. */
    private com.fedex.ship.stub.Money effectiveNetDiscount;

    /* Each element of this field provides shipment-level rate data
     ...
     * 
     * @return actualRateType   * Identifies which entry in the ShipmentRateDetails array is
     * considered as presenting the actual rates for the shipment.
     */
     ...
     * 
     * @param actualRateType   * Identifies which entry in the ShipmentRateDetails array is
     * considered as presenting the actual rates for the shipment.
     */
     ...
     * 
     * @return effectiveNetDiscount   * The difference between account based rates and list rates.
     * Only returned when list rates are requested.
     */
     ...
     * 
     * @param effectiveNetDiscount   * The difference between account based rates and list rates.
     * Only returned when list rates are requested.
     */
     ...
     * 
     * @return shipmentRateDetails   * Each element of this field provides shipment-level rate data
     * for a specific rate type.
     */
     ...
     * 
     * @param shipmentRateDetails   * Each element of this field provides shipment-level rate data
     * for a specific rate type.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "ShipmentRating"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("actualRateType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "ActualRateType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "EffectiveNetDiscount"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "ShipmentRateDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "ShipmentRateDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
