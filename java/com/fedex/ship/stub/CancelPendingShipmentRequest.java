...
public class CancelPendingShipmentRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the trackingNumber value for this CancelPendingShipmentRequest.
     * 
    ...
    /**
     * Sets the trackingNumber value for this CancelPendingShipmentRequest.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "CancelPendingShipmentRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "TrackingNumber"));
