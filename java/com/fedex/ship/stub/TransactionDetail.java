...
public class TransactionDetail  implements java.io.Serializable {
    /* Identifies a customer-supplied unique identifier for this transaction.
     * It is returned in the reply message to aid in matching requests to
     * replies. */
    private java.lang.String customerTransactionId;

    /* Governs any future language/translations applied to the data
     * payload(contrasted with ClientDetail.localization, which governs Notification.localizedMessage
     * language selection). */
     ...
     * 
     * @return customerTransactionId   * Identifies a customer-supplied unique identifier for this transaction.
     * It is returned in the reply message to aid in matching requests to
     * replies.
     */
     ...
     * 
     * @param customerTransactionId   * Identifies a customer-supplied unique identifier for this transaction.
     * It is returned in the reply message to aid in matching requests to
     * replies.
     */
     ...
     * 
     * @return localization   * Governs any future language/translations applied to the data
     * payload(contrasted with ClientDetail.localization, which governs Notification.localizedMessage
     * language selection).
     */
     ...
     * 
     * @param localization   * Governs any future language/translations applied to the data
     * payload(contrasted with ClientDetail.localization, which governs Notification.localizedMessage
     * language selection).
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "TransactionDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("customerTransactionId");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "CustomerTransactionId"));
