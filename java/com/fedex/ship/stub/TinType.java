...
public class TinType implements java.io.Serializable {
    ...
    public static final java.lang.String _EIN = "EIN";
    public static final java.lang.String _SSN = "SSN";
    public static final TinType EIN = new TinType(_EIN);
    public static final TinType SSN = new TinType(_SSN);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "TinType"));
    }
    /**
