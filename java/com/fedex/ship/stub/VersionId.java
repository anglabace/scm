...
public class VersionId  implements java.io.Serializable {
    ...
    /* Identifies the service business level. For this release this
     * value should be set to 6. */
    private int major;

    /* Identifies the service interface level. For this release this
     * value should be set to 0. */
    private int intermediate;

    /* Identifies the service code level. For this release this value
     * should be set to 0. */
    private int minor;
     ...
     * 
     * @return major   * Identifies the service business level. For this release this
     * value should be set to 6.
     */
    public int getMajor() {
        return major;
     ...
     * 
     * @param major   * Identifies the service business level. For this release this
     * value should be set to 6.
     */
     ...
     * 
     * @return intermediate   * Identifies the service interface level. For this release this
     * value should be set to 0.
     */
     ...
     * 
     * @param intermediate   * Identifies the service interface level. For this release this
     * value should be set to 0.
     */
     ...
     * 
     * @return minor   * Identifies the service code level. For this release this value
     * should be set to 0.
     */
    public int getMinor() {
        return minor;
     ...
     * 
     * @param minor   * Identifies the service code level. For this release this value
     * should be set to 0.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "VersionId"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("serviceId");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "ServiceId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("major");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "Major"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("intermediate");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "Intermediate"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("minor");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "Minor"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
