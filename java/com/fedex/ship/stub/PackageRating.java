...
public class PackageRating  implements java.io.Serializable {
    /* Identifies which entry in the PackageRateDetails array is considered
     * as presenting the actual rates for the package. */
     ...
     * 
     * @return actualRateType   * Identifies which entry in the PackageRateDetails array is considered
     * as presenting the actual rates for the package.
     */
     ...
     * 
     * @param actualRateType   * Identifies which entry in the PackageRateDetails array is considered
     * as presenting the actual rates for the package.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "PackageRating"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "PackageRateDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "PackageRateDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
