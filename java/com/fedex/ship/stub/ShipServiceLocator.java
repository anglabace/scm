...
public class ShipServiceLocator extends org.apache.axis.client.Service implements com.fedex.ship.stub.ShipService {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2293850617505969408L;
    ...
    //private java.lang.String ShipServicePort_address = "https://gatewaybeta.fedex.com:443/web-services";
    private java.lang.String ShipServicePort_address = "https://199.81.204.97:443/web-services";//beta;
    //private java.lang.String ShipServicePort_address = "https://199.81.218.57:443/web-services";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "ShipService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "ShipServicePort"));
        }
