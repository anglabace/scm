...
public class Address  implements java.io.Serializable {
     ...
     * country. This element is required if both the City and StateOrProvinceCode
     * are not present. */
    private java.lang.String postalCode;

    /* Relevant only to addresses in Puerto Rico. In Puerto Rico,
     * multiple addresses within the same ZIP code can have the same house
     * number and street name. When this is the case, the urbanization code
     ...
     * 
     * @return urbanizationCode   * Relevant only to addresses in Puerto Rico. In Puerto Rico,
     * multiple addresses within the same ZIP code can have the same house
     * number and street name. When this is the case, the urbanization code
     * is needed to distinguish them.
     */
     ...
     * 
     * @param urbanizationCode   * Relevant only to addresses in Puerto Rico. In Puerto Rico,
     * multiple addresses within the same ZIP code can have the same house
     * number and street name. When this is the case, the urbanization code
     * is needed to distinguish them.
     */
     ...
     * 
     * @return countryCode   * Identification of a country.
     */
     ...
     * 
     * @param countryCode   * Identification of a country.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "Address"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("streetLines");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "StreetLines"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "City"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "UrbanizationCode"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v7", "Residential"));
