...
$(document).ready(function(){
	...
	$("#shipAreaEdit").click(function(){
		...
		$.ajax({
			  type: "post",
			  url: "serv/serv_inventory!saveEdit.action?psId="+psId+"&effFrom="+effFrom+"&effTo="+effTo+"&shipAreaId="+shipAreaId+"&shipInfo="+shipInfoOld+"&type="+parent.pdtServType+"&sessionServiceId="+sessionServiceId,
			  data: "",
