...
function install(el, opts) {
    topWin = opts.topWin == undefined ? window.self : opts.topWin;
		//full是代表全屏的Boolean变量
    ...
    var arr = [];
		...
		if(opts.showDialog){
			...
			/*arr.push("<table width=\"100\" height=\"59\" style=\"border:solid #5e97cc 1px; background-color:#FFFFFF \">");
			arr.push("  <tr>");
			arr.push("    <td width=\"74\" height=\"53\" align=\"center\" valign=\"middle\"><img src=\"images/indicator.gif\" width=\"100\" height=\"100\" /></td>");
			arr.push("  	<td width=\"114\" align=\"left\" valign=\"middle\">");
			arr.push("  </tr>");
			arr.push("</table>");*/
            arr.push("<img style=\"background:#000;color:white;width:200px;position:absolute;left:10px;top:10px;filter: Alpha(opacity=100);-moz-opacity:0.1;opacity:1;\" src=\"images/ajax-loader2.gif\" width=\"32\" height=\"32\" />");
		}
...
function remove(el, opts) {
    if(!$("div[id^='_DialogBGDiv']")) return;
    topWin = (opts==undefined || opts.topWin == undefined) ? window.self : opts.topWin;
    var full = el == window.top;
    opts = $.extend({}, $.funkyUI.defaults, opts || {});
    if (full) {
