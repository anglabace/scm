...
function chooseCategoryNo(cId) {
	...
	if(type=='1'){
		...
		parent.parent.$("#promotion_edit_iframe").contents().find('#discCategoryType').val("PRODUCT");
		parent.parent.$("#promotion_add_iframe").contents().find("#discCategory1").val(cId);
		parent.parent.$("#promotion_add_iframe").contents().find('#discCategoryType').val("PRODUCT");
	}else if(type=='2'){
		...
		parent.parent.$("#promotion_edit_iframe").contents().find("#orderItemCategory").val(cId);
		parent.parent.$("#promotion_edit_iframe").contents().find('#orderItemCategoryType').val("PRODUCT");
		parent.parent.$("#promotion_add_iframe").contents().find("#orderItemCategory").val(cId);
		parent.parent.$("#promotion_add_iframe").contents().find('#orderItemCategoryType').val("PRODUCT");
	}
...
<body>
    ...
    <s:iterator value="productCategoryList">
    <tr>
    <td width="300">
    ...
    <div class="grayr">
			<jsp:include page="/common/db_pager.jsp">
			  <jsp:param value="${ctx}/basedata/category_picker!getProductCategory.action" name="moduleURL"/>
			</jsp:include>
		</div>
