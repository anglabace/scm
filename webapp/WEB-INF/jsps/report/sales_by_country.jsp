			...
			<div class="input_box">
				<div class="content_box">
					<form id="save_form" method="post" class="niceform" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="actionPage" id="actionPage" value="sales_by_country"/>
								...
								<td>
									...
									<div id="Filter_Parameters" class="disp" style="display: block;">
										<table border="0" cellpadding="0" cellspacing="0" class="General_table">
                                            ...
                                            <tr>
                                                <th width="204">Country</th>
												<td colspan="1" width="160px">
                                                    <s:select list="countryList" listKey="countryCode"
														listValue="name" name="reportDataDto.country" id="country"
														value="reportDataDto.country" cssStyle="width:80%"/>
												</td>
                                            </tr>
											<tr>
												<th>Status</th>
