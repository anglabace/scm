...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Sales By Sales Representative</title>
			...
			<div class="input_box">
				<div class="content_box">
					<form id="save_form" method="post" class="niceform" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="actionPage" id="actionPage" value="sales_by_Sales_Rep"/>
                        <input type="hidden" name="reportDataDto.reportType" id="reportType" value="rep"/>
								...
								<td>
									...
									<div id="Filter_Parameters" class="disp" style="display: block;">
										<table border="0" cellpadding="0" cellspacing="0" class="General_table">
                                            ...
                                            <tr>
                                                <th width="204">Sales Department</th>
												<td colspan="1" width="160px">
                                                    <s:select list="departmentses" listKey="deptId"
														listValue="name" name="reportDataDto.salesDepartment" id="reportDataDto.salesDepartment"
														value="reportDataDto.salesDepartment" cssStyle="width:80%"/>
												</td>
                                                <th width="204">Sales Representative</th>
												<td colspan="1" width="160px">
                                                    <s:select list="users" listKey="salesId"
														listValue="resourceName" name="reportDataDto.SalesRepresentative" id="reportDataDto.SalesRepresentative"
														value="reportDataDto.SalesRepresentative" cssStyle="width:80%"/>
												</td>
                                            </tr>
											<tr>
												<th>Status</th>
                                            ...
                                            <tr id="quotationShow" style="display:''">
                                                <th width="204"></th>
                                                <td colspan="1" width="160px"><s:checkbox name="reportDataDto.status" id="reportDataDto.quotationStatus.open" fieldValue="NW"/>New</td>
                                            ...
                                            <tr id="orderShow1" style="display:none">
                                                ...
                                                <td colspan="1" width="160px"><s:checkbox name="reportDataDto.status" id="reportDataDto.orderStatus.open" fieldValue="RV"/>Order on Review</td>
