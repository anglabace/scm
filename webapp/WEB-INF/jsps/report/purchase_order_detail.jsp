			...
			<div class="input_box">
				<div class="content_box">
					<form id="save_form" method="post" class="niceform" enctype="multipart/form-data">
                        <input type="hidden" name="serviceMethod" id="serviceMethod" value="getPurchaseOrderReportDate"/>
                        <input type="hidden" name="actionPage" id="actionPage" value="purchase_order_detail"/>
								...
								<td>
									...
									<div id="Filter_Parameters" class="disp" style="display: block;">
										<table border="0" cellpadding="0" cellspacing="0" class="General_table">
                                            ...
                                            <tr>
                                                <th width="204">Vendor</th>
												<td colspan="1" width="160px">
                                                    <s:select list="vendorList" listKey="id"
														listValue="name" name="reportDataDto.vendorId" id="vendorId"
														value="reportDataDto.vendorId" cssStyle="width:80%"/>
												</td>
                                            </tr>
											<tr>
												<th>Status</th>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="1" width="160px"><s:checkbox name="reportDataDto.status" id="reportDataDto.status.cc" fieldValue="Received"/>Fully Received</td>
                                                <td colspan="1" width="160px"><s:checkbox name="reportDataDto.status" id="reportDataDto.status.vc" fieldValue="CN"/>Cancelled</td>
									...
									<div id="OutPut_Param" class="disp" style="display:block;">
										<table border="0" cellpadding="0" cellspacing="0" class="General_table">
											...
											<tr>
                                                <th width="210"></th>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.orderNo" fieldValue="orderNo:Purchase Order #"/>Purchase Order #</td>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.vendor" fieldValue="vendorName:Vendor"/>Vendor</td>
                                                ...
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.freight" fieldValue="srcSoNo:Sale Order Ref"/>Sale Order Ref</td>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.tax" fieldValue="orderDate:Order Date"/>Order Date</td>
											</tr>
                                            <tr>
                                                <th width="210"></th>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.total" fieldValue="subTotal:Total"/>Total</td>
                                            </tr>
										</table>
									</div>
								</td>
