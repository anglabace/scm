									...
									<div id="OutPut_Param" class="disp" style="display:block;">
										<table border="0" cellpadding="0" cellspacing="0" class="General_table">
											...
											<tr>
                                                ...
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.total" fieldValue="total:Total"/>Total</td>
											</tr>
                                            <tr>
                                                <th width="210"></th>
                                                <td  colspan="1"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.pm" fieldValue=""/>Close Ratio</td>
                                            </tr>
										</table>
									</div>
								</td>
    ...
    $(function() {
        ...
        $("#report").click(
                          function() {
                              ...
                              document.forms[0].action = "report!getQuotaionReportDate.action";
        ...
        $("#chart").click(
                         function() {
                             ...
                             var formStr = $("#save_form").serialize();
                             $('#report').attr("disabled", true);
                             document.forms[0].action = "report!getCommonMethodPicAnalysis.action?serviceMethod=getQuotationReportDate";
                             document.forms[0].target = "operation_list_frame";
                             document.forms[0].submit();
                             $('#report').attr("disabled", false);
                         });
        ...
        $("#excelExport").click(
                               function() {
                                   ...
                                   var formStr = $("#save_form").serialize();
                                   $('#report').attr("disabled", true);
                                   document.forms[0].action = "report!getQuotationSummaryExcelExport.action";
                                   document.forms[0].target = "operation_list_frame";
                                   document.forms[0].submit();
                                   $('#report').attr("disabled", false);
                               });
        ...
        $("#pdfExport").click(
                             function() {
                                 ...
                                 var formStr = $("#save_form").serialize();
                                 $('#report').attr("disabled", true);
                                 document.forms[0].action = "report!getQuotationSummaryPDFExport.action";
                                 document.forms[0].target = "operation_list_frame";
                                 document.forms[0].submit();
                                 $('#report').attr("disabled", false);
                             });
