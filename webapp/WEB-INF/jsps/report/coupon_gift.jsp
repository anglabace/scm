...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Coupon & Gift Card Summary</title>
			...
			<div class="input_box">
				<div class="content_box">
					<form id="save_form" method="post" class="niceform"
                        ...
                        <input type="hidden" name="serviceMethod" id="serviceMethod" value="getCouponCardReportDate"/>
                        <input type="hidden" name="actionPage" id="actionPage" value="coupon_gift"/>
								...
								<td>
									...
									<div id="Filter_Parameters" class="disp" style="display: block;">
										<table border="0" cellpadding="0" cellspacing="0" class="General_table">
                                            ...
                                            <tr>
                                                <th width="204">Discount Type</th>
												<td colspan="1" width="160px">
                                                    <s:select list="#{'coupon':'Coupon', 'gift' : 'Gift Card'}" headerKey=""
														headerValue="All" name="reportDataDto.type" id="reportDataDto.type"
														value="reportDataDto.type" cssStyle="width:80%"/>
												</td>
                                            </tr>
											<tr>
												<th>Status</th>
									...
									<div id="OutPut_Param" class="disp" style="display:block;">
										<table border="0" cellpadding="0" cellspacing="0" class="General_table">
											...
											<tr>
                                                <th width="210"></th>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.type" fieldValue="discountType:Discount Type"/>Discount Type</td>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.status" fieldValue="status:Order Status"/>Order Status</td>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.subtotal" fieldValue="total:Order Total"/>Order Total</td>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.freight" fieldValue="discountTotal:Discount Total"/>Discount Total</td>
											</tr>
										</table>
									</div>
								</td>
...
//	};
    ...
    $("#chart").click(
            function(){
                ...
                var formStr = $("#save_form").serialize();
                $('#report').attr("disabled", true);
                document.forms[0].action = "report!getCommonMethodPicAnalysis.action?serviceMethod=getCouponCardReportDate";
                document.forms[0].target = "operation_list_frame";
                document.forms[0].submit();
                $('#report').attr("disabled", false);
       });
