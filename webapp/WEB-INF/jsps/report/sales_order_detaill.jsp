								...
								<td>
									...
									<div id="Filter_Parameters" class="disp" style="display: block;">
										<table border="0" cellpadding="0" cellspacing="0" class="General_table">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="1" width="160px"><s:checkbox name="reportDataDto.status" id="reportDataDto.status.review" fieldValue="RV"/>Order on Review</td>
                                                <td colspan="1" width="160px"><s:checkbox name="reportDataDto.status" id="reportDataDto.status.co" fieldValue="CC"/>Customer Confirmed</td>
                                                <td colspan="1" width="160px"><s:checkbox name="reportDataDto.status" id="reportDataDto.status.coo" fieldValue="CO"/>Vendor Confirmed </td>
                                                <td colspan="1" width="160px"><s:checkbox name="reportDataDto.status" id="reportDataDto.status.fs" fieldValue="SH"/>Fully Shipped</td>
                                                <td colspan="1" width="160px"><s:checkbox name="reportDataDto.status" id="reportDataDto.status.invoiced" fieldValue="" disabled="true"/>Invoiced</td>
											</tr>
                                            <tr>
                                                <th width="204"></th>
                                                <td colspan="1" width="160px"><s:checkbox name="reportDataDto.status" id="reportDataDto.status.paid" fieldValue="" disabled="true"/>Paid</td>
									...
									<div id="OutPut_Param" class="disp" style="display:block;">
										<table border="0" cellpadding="0" cellspacing="0" class="General_table">
											...
											<tr>
                                                <th width="210"></th>
												<td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.quotation" fieldValue="orderNo:Order#"/>Order#</td>
                                            ...
                                            <tr>
                                                <th width="210"></th>
                                                <td><s:checkbox name="reportDataDto.column" id="reportDataDto.column.currency" fieldValue="orderCurrency:Currency"/>Currency</td>
                                                <td><s:checkbox name="reportDataDto.column" id="reportDataDto.column.qd" fieldValue="orderDate:Order Date"/>Order Date</td>
                                                <%--<td><s:checkbox name="reportDataDto.column" id="reportDataDto.column.qcd" fieldValue="quotationCloseDate:Quotation Close Date"/>Invoice Date</td>--%>
                                                <%--<td><s:checkbox name="reportDataDto.column" id="reportDataDto.column.qcd" fieldValue="quotationCloseDate:Quotation Close Date"/>Payment Date</td>--%>
                                                <td><s:checkbox name="reportDataDto.column" id="reportDataDto.column.tax" fieldValue="tax:Tax"/>Total Tax</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><s:checkbox name="reportDataDto.column" id="reportDataDto.column.total" fieldValue="salesTerritoryName:Territory"/>Territory</td>
                                                <td><s:checkbox name="reportDataDto.column" id="reportDataDto.column.total" fieldValue="orgName:Organization"/>Organization</td>
                                                <td><s:checkbox name="reportDataDto.column" id="reportDataDto.column.total" fieldValue="salesContactName:SM"/>SM</td>
                                                <td><s:checkbox name="reportDataDto.column" id="reportDataDto.column.total" fieldValue="techSupportName:TAM"/>TAM</td>
                                            ...
                                            <tr>
                                                ...
                                                <select name="reportDataDto.sortBy1" id="reportDataDto.sortBy1">
                                                    <option value="order_Date">Quotation Date</option>
                                                </select></td>
                                                <th>2nd Sort By</th>
 ...
 $("#save_form").validate({
    ...
    $(function() {
        ...
        $("#report").click(function() {
            ...
            document.forms[0].action = "report!getSalesDetail.action";
        ...
        $("#excelExport").click(function() {
            ...
            var formStr = $("#save_form").serialize();
            $('#report').attr("disabled", true);
            document.forms[0].action = "report!getSalesDetailExcelExport.action";
            document.forms[0].target = "operation_list_frame";
            document.forms[0].submit();
            $('#report').attr("disabled", false);
        });
        ...
        $("#pdfExport").click(function() {
            ...
            var formStr = $("#save_form").serialize();
            $('#report').attr("disabled", true);
            document.forms[0].action = "report!getSalesDetailPDFExport.action";
            document.forms[0].target = "operation_list_frame";
            document.forms[0].submit();
            $('#report').attr("disabled", false);
        });
