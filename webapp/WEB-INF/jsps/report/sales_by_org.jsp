...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Sales By Organization</title>
			...
			<div class="input_box">
				<div class="content_box">
					<form id="save_form" method="post" class="niceform" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="actionPage" id="actionPage" value="sales_by_org"/>
                        <input type="hidden" name="reportDataDto.reportType" id="reportType" value="org"/>
								...
								<td>
									...
									<div id="Filter_Parameters" class="disp" style="display: block;">
										<table border="0" cellpadding="0" cellspacing="0" class="General_table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input style="margin-left:40px" type="radio" name="reportType" id="quotationType" value="quotation" checked="true" onclick="showType()"/>Quotation
                                                </td>
                                                <td>
                                            ...
                                            <tr>
												...
												<td colspan="1" width="160px">
													<s:select list="techManagers" listKey="id"
														...
														value="reportDataDto.techManager" cssStyle="width:80%"/>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
												...
												<td colspan="1" width="180px">
                                                    <s:select list="organizations" listKey="id"
														...
														value="reportDataDto.orgType" cssStyle="width:100%"/>
												</td>
                                            ...
                                            <tr id="orderShow1" style="display:none">
                                                <th width="204"></th>
                                                <td colspan="1" width="160px"><s:checkbox name="reportDataDto.status" id="reportDataDto.orderStatus.open" fieldValue="OP"/>Open</td>
									...
									<div id="OutPut_Param" class="disp" style="display:block;">
										<table border="0" cellpadding="0" cellspacing="0" class="General_table">
											...
											<tr>
                                                <th width="210"></th>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.orgType" fieldValue=""/>Organization Type</td>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.orgName" fieldValue="orgName:Organization Name"/>Organization Name</td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.territory" fieldValue="salesTerritoryName:Territory"/>Territory</td>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.sm" fieldValue="salesContactName:SM"/>SM</td>
                                            </tr>
                                            <tr>
                                                <th width="210"></th>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.tam" fieldValue="techSupportName:TAM"/>TAM</td>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.pm" fieldValue="projectManagerName:PM"/>PM</td>
                                            </tr>
										</table>
									</div>
								</td>
