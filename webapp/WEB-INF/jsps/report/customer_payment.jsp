			...
			<div class="input_box">
				<div class="content_box">
					<form id="save_form" method="post" class="niceform" enctype="multipart/form-data">
                        <input type="hidden" name="serviceMethod" id="serviceMethod" value="getCusPaymentReportDate"/>
                        <input type="hidden" name="actionPage" id="actionPage" value="customer_payment"/>
									...
									<div id="OutPut_Param" class="disp" style="display:block;">
										<table border="0" cellpadding="0" cellspacing="0" class="General_table">
											...
											<tr>
                                                ...
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.cost" fieldValue="subTotal:Subtotal"/>Cost</td>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.amount" fieldValue="shipAmt:Freight"/>Amount</td>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.profit" fieldValue="tax:Tax"/>Profit</td>
                                                <td colspan="1" width="170px"><s:checkbox name="reportDataDto.column" id="reportDataDto.column.pm" fieldValue="amount:Total"/>Profit Margin</td>
											</tr>
										</table>
									</div>
								</td>
