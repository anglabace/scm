...
<link media="all" type="text/css" rel="stylesheet"
	href="${global_css_url}openwin.css">
	<style type="text/css">
<!--
...
<body>
	<s:form action="q_clerks!selectUser" name="docTempSearch"
	...
	<table width="660" border="0" cellspacing="0" cellpadding="0">
			...
			<td colspan="4">
				<div style="width: 657px; height: 210px; overflow: scroll;">
					<table width="640" border="0" cellpadding="0" cellspacing="0"
						...
						<s:iterator value="usersPage.result" status="st">
							<s:if test="#st.odd">
								<tr>
									<td width="46"><input type="radio" value="${loginName}"
							...
							<s:else>
								<tr>
									<td class="list_td2"><input type="radio"
										value="${loginName}" id="${userId}" name="userId" /></td>
				...
				<div class="grayr">
					<jsp:include page="/common/db_pager.jsp">
						<jsp:param value="${ctx}/q_clerks!selectUser.action"
							name="moduleURL" />
					</jsp:include>
				</div>
			</td>
		...
		<tr>
			<td colspan="4" class="botton_box"><input name="Submit"
				type="button" id="select_btn" class="style_botton" value="Select"
				onclick="addUser()" /> <input type="submit" name="Submit2"
