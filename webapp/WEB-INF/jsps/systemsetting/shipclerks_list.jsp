...
<body class="content" style="background-image: none;">
			...
			<div style="margin-right: 17px;">
				<table width="966" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<th width="46">
							<div align="left">
								<input type="checkbox" onclick="cc(this, 'clerkId')" /> <a
									href="javascript:void(0)" onclick="del_ship_clerk()"
						...
						<th>Assigned Product/Service</th>
			...
			<div class="list_box" style="height: 340px; width: 983px;">
				<table width="966" border="0" cellspacing="0" cellpadding="0"
					...
					<s:iterator value="page.result">
						<tr>
							<td width="46"><input type="checkbox" value="${clerkId}"
								name="clerkId" /></td>
							<td width="48">${clerkId}&nbsp;</td>
							<td width="144"><a target="_parent"
								href="shipping_clerks_srch!input.action?clerkId=${clerkId}&operation_method=edit">${name}&nbsp;</a>
							</td>
	...
	<div class="button_box">
		<input type="submit"
			onclick="parent.location.href='shipping_clerks_srch!input.action'"
			value="New Clerk" class="search_input" name="Submit" />
	</div>
