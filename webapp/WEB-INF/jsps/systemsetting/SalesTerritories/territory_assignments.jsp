...
<div class="title_content">
  <div class="title_new"><a href="javascript:void(0);" onclick="toggleShowMorea('total_title');" id="total_titleItem"><img src="${global_url}images/arrow1.jpg" /></a>&nbsp;Sales Territory Assignments</div>
</div>
<div class="search_box" id="total_title">
  <div class="search_box_two">
  <s:form action="territory_assign!list" target="result_iframe" name="SalesResourceSearch" method="get" onsubmit="return check();">
  	  <table border="0" cellpadding="0" cellspacing="0" class="General_table">
      <tr>
        <th>Sales Resource Name</th>
        <td><input name="filter_LIKES_resourceName" id="filter_LIKES_resourceName" type="text" class="NFText" size="20" /></td>
        <th>Status</th>
        <td width="120"><s:select id="status_sel"  
        ...
        <th>Function</th>
          <td width="120">
          <s:if test="dropDownMap['SALES_REP_FUNCTION']!=null">
          	 <s:select name="filter_EQS_function"
          ...
          <s:else>
          <select name="filter_EQS_function">
...
<s:hidden id="choiceOption"></s:hidden>
		...
		src="territory_assign!list.action" width="100%" height="400"
		frameborder="0" scrolling="no"></iframe>
		</div>
  </div>
  <div  class="button_box">
  <a href="javascript:void(0)" onclick="window.location.href='territory_assign!load.action'"><input type="button" name="Submit52" value="New" class="search_input"/></a>
</div>	
</div>	
</body>
</html>