...
<div class="title_content">
  <div class="title_new"><a href="javascript:void(0);" onclick="toggleShowMorea('total_title');" id="total_titleItem"><img src="${global_url}images/arrow1.jpg" /></a>&nbsp;Sales Resources</div>
</div>
<div class="search_box" id="total_title">
  <div class="search_box_two">
  <s:form action="sales_resource!list" target="result_iframe" name="SalesResourceSearch" method="get" onsubmit="return check();">
...
<s:hidden id="choiceOption"></s:hidden>
		...
		src="sales_resource!list.action" width="100%" height="400"
		frameborder="0" scrolling="no"></iframe>
		</div>
  </div>
  <div  class="button_box">
  <a href="javascript:void(0)" onclick="window.location.href='sales_resource!load.action'"><input type="button" name="Submit52" value="New" class="search_input"/></a>
</div>	
</div>	
</body>
</html>