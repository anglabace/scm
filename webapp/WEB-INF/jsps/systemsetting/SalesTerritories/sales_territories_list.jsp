	    ...
	    $("#check_del").click(function(){
			 if ($(":checkbox:gt(0):checked").length < 1) {
			      alert('Please select one to continue your operation!');
					...
					$.ajax({
						type: "POST",
						url: "sales_territories!delete.action",
...
<table width="1010" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="993" border="0" cellspacing="0" cellpadding="0" class="list_table">
      <tr>
        ...
        <th width="207">Sales Territory Code</th>
	    <th width="356">Sales Territory Name</th>
  ...
  <tr>
	...
	<div class="list_box">
      ...
      <s:if test="salesTerritoryPage!=null&&salesTerritoryPage.result!=null">
      <s:iterator value="salesTerritoryPage.result" status="st">
      <s:if test="#st.odd">
	      <tr>
	      	 <td width="46"><input type="checkbox" value="${territoryId}" id="${territoryId}" onclick="choice(this);" name=delRouteId/></td>
	      	 <td width="207"><a href="sales_territories!load.action?territoryId=<s:property value='territoryId'/>" target="_parent">${territoryCode}</a></td>
	         <td width="356">${territoryName}</td>
      ...
      <s:else>
      	<tr>
        <td class="list_td2"><input type="checkbox" value="${territoryId}" id="${territoryId}" onclick="choice(this);" name=delRouteId/></td>
        <td class="list_td2"><a href="sales_territories!load.action?territoryId=<s:property value='territoryId'/>" target="_parent">${territoryCode}</a></td>
  ...
  <tr>
	  ...
	  <jsp:include page="/common/db_pager.jsp">
			<jsp:param value="${ctx}/sales_territories!list.action" name="moduleURL" />
	  </jsp:include>
	  </div>
	  </td>
  </tr>
