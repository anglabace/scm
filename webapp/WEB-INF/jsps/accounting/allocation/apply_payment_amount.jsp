...
function AmounttoApply()
{
	...
	var invoice=new Number(${arInvoice.balance});
...
function commit()
{
    ...
    window.parent.$("#invoice_id").val("${arInvoice.invoiceId}");
          ...
          <tr>
            <td><br />
              ...
              <tr>
                ...
                <td width="150"><input name="textfield23" type="text" class="NFText" value="${arInvoice.invoiceNo}" size="20" /></td>
                <th >&nbsp;</th>
                </tr>
              <tr>
                <th>Subtotal</th>
                <td><input name="textfield2" type="text" class="NFText2" value="${arInvoice.subTotal}" size="20" />${arInvoicePayment.symbol}</td>
                <th>&nbsp;</th>
                </tr>
              <tr>
                <th>Shipping</th>
                <td><input name="textfield22" type="text" class="NFText2" value="${arInvoice.shipping}" size="20" />${arInvoicePayment.symbol}</td>
                <th>&nbsp;</th>
                </tr>
              <tr>
                <th>Tax</th>
                <td><input name="textfield" type="text" class="NFText2" value="${arInvoice.tax}" size="20" />${arInvoicePayment.symbol}</td>
                <th>&nbsp;</th>
                </tr>
              <tr>
                <th>Total</th>
                <td><input name="textfield3" type="text" class="NFText2" value="${arInvoice.totalAmount}" size="20" />${arInvoicePayment.symbol}</td>
                <th>&nbsp;</th>
                </tr>
              <tr>
                <th>Balance</th>
                <td><input name="textfield4" type="text" class="NFText2" value="${arInvoice.balance}" size="20" />${arInvoicePayment.symbol}</td>
                <th>&nbsp;</th>
                </tr>
              <tr>
                <th>Amount to Apply</th>
                <td><input name="amounttoApply" id="amounttoApply"   type="text" class="NFText2" value="" size="20" readonly />${arInvoicePayment.symbol}</td>
                <td>&nbsp;</td>
                </tr>
              <tr>
                <th valign="top">Invoice Ending Balance</th>
                <td><input name="InvoiceBalance" id="InvoiceBalance"  type="text" class="NFText2" value="0" size="20"  readonly />${arInvoicePayment.symbol}</td>
              ...
              <tr>
                ...
                <td><input name="paymentBalance" id="paymentBalance"   type="text" class="NFText2" value="0" size="20"  readonly />${arInvoicePayment.symbol}</td>
                <td><span class="list_td2">
