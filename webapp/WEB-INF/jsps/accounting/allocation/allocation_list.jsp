...
function allocation()
{
   ...
   $(":radio").each(
    ...
    window.location.href='ar_invoice_allocation!Reconcile.action?id='+payment;
}	
...
<div class="search_box" >
 <div class="search_box_two">             
  <form name="form1" method="get" action="ar_invoice_allocation!GetList.action">
  ...
  <tr>
    <td colspan="6" align="center">
    	<input type="submit" name="Submit1" value="Search" class="search_input" />
     	<input type="button" name="Submit2" value="Refresh List" onclick="location.href='ar_invoice_allocation!GetList.action'" class="search_input" />
    </td>
    </tr>
 </table>
</form>
                  ...
                  <table width="993" border="0" cellspacing="0" cellpadding="0" class="list_table">
                    <tr>
                      <th width="30"><div align="center">
                        <input type="radio" name="selectId" id="selectId"   value="0" />
                      </div></th>
                  ...
                  <table width="993" border="0" cellspacing="0" cellpadding="0" id="list_table" class="list_table2">
                     <s:iterator value="arInvoicePaymentPage.result">
					      <tr>
					        ...
					        <td  width="130"><a href="ar_invoice_allocation!forwardRecord.action?arInvoicePaymentDto.transactionId=${transactionId}">${transactionId}</a></td>
					        <td  width="76" >${custNo}</td>					        
					        <td  width="182">${transactionType}</td>
					        <td  width="84" >${symbol}${amount}</td>
					        <td  width="113">${symbol}${applyAmount== null ? 0.0 : applyAmount}</td>
								...
								<td>
									...
									<div class="grayr">
										<jsp:include page="/common/db_pager.jsp">
											<jsp:param value="${ctx}/ar_invoice_allocation!GetList.action"
												name="moduleURL" />
										</jsp:include>
									</div>
