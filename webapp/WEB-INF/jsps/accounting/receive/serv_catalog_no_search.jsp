...
$(function(){
		$("#Product").click(function(){
		    ...
		    $("#pro").show();
		    $("#ser").hide();
		    //$("#panel1").location = "ar_invoice/ar_invoice!catalogNoSearch.action";
		    //window.document.getElementById("#panel0").location = "ar_invoice/ar_invoice!catalogNoSearch.action";
		...
		$("#Service").click(function(){
            ...
            $("#panel0").hide();
	   		...
	   		//window.document.getElementById("#panel1").location = "ar_invoice/ar_invoice!catalogNoSearch.action";
	...
	//function selectCatalogNo () {
		//alert($("#servCatalogNo").val());
		//alert($("#productCatalogNo").val());
	//}
</script>
...
<div class="search_box">
 <div class="search_box_three"> 
        ...
        <table  border="0" cellpadding="0" cellspacing="0" class="Customer_table" id="ser" style="display:block;">
          <tr>
            ...
            <td><input name="filter_LIKES_name" type="text" value="${param.filter_LIKES_name }" class="NFText" size="20"/></td>
...
<ul class="TabbedPanelsTabGroup">
    <li class="TabbedPanelsTab" tabindex="0" id="Product">Product</li>
    <li class="TabbedPanelsTab TabbedPanelsTabSelected" tabindex="1" id="Service">Service</li>
</ul>
   <div class="TabbedPanelsContentGroup">
     <div style="display:none;" class="TabbedPanelsContent" id="panel0">
  ...
  <div style="width:687px; height:230px; overflow:scroll;">
    <table width="650"  border="0" cellpadding="0" cellspacing="0" class="list_table">
    </table>
  </div>
  <br/>
      <div class="grayr">
...
<div style="display: block;" class="TabbedPanelsContent" id="panel1">
 	<table width="670" border="0"  cellpadding="0" cellspacing="0" class="list_table"  style=" margin-top:10px;">
       <tr>
         <th width="46">&nbsp;</th>
     ...
     <div style="width:687px; height:230px; overflow:scroll;">
		...
		<s:iterator value="servicePageBean.result">
			<tr>
             <td width="46"><input type="radio" id="servCatalogNo" name="${name }" value="${catalogNo}" uom="${uom }"  /></td>
...
<input type="submit" value="Cancel"  class="style_botton" onclick="window.parent.closeiframe()"/>
</div>
</div>
</body>
