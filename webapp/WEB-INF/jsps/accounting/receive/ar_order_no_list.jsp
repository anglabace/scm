    ...
    <table width="449" border="0" cellspacing="0" cellpadding="0" height="339">
      ...
      <tr>
        <td style="padding-left:60px;"><br />
          ...
          <tr>
            <td>
            <form method="get" target="_self" id="searchForm" action="genscript!orderNoSearch.action">
            <input type="hidden" name="filter_EQI_custNo" value="${param.filter_EQI_custNo }"/>
              ...
              <table width="373" border="0" cellspacing="0" cellpadding="0" height="244">
                ...
                <tr>
                  <td><div  style="width:367px; height:130px; overflow:scroll;">
                    ...
                    <s:iterator value="orderMainBeanPage.result" var="orderNo">
                      <tr>
      ...
      <td>
		<div class="grayr">
			...
			<jsp:include page="/common/db_pager.jsp">
			  <jsp:param value="${ctx}/genscript!orderNoSearch.action" name="moduleURL"/>
			</jsp:include>
