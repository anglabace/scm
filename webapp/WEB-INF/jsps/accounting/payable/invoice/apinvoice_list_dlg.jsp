...
function doCancel(){
		window.parent.$('#new_invoice_dlg').dialog('close');
}
    ...
    <td bgcolor="#FFFFFF"><table width="449" border="0" cellspacing="0" cellpadding="0" height="339">
      ...
      <tr>
        <td style="padding-left:60px;"><br />
          ...
          <tr>
            <td>
            <form method="get" target="_self" id="searchForm" action="genscript!ApInvoiceList.action">
              ...
              <table width="373" border="0" cellspacing="0" cellpadding="0" height="244">
                <tr>
                  <td style="padding-top:10px;"><table width="350" border="0" cellpadding="0" cellspacing="0" class="list_table">
                    <tr>
                      <th width="30">&nbsp;</th>
                       <th width="30px">Invoice Id</th>
                      <th width="60px">Invoice No</th>
                      <th width="60px">Currency</th>
                      <th width="60px">Paid Amount</th>
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td><div  style="width:367px; height:130px; overflow:scroll;">
                    ...
                    <s:iterator value="apinvoiceListPage.result" >
                      <tr>
                        ...
                        <td width="30px">${invoiceId}</td>
                        <td width="60px">${invoiceNo}</td>
                        <td width="60px">${currency}</td>
                        <td width="60px"> ${paidAmt}</td>
                      </tr>
                    </s:iterator>
                    </table>
                  </div></td>
      ...
      <td>
		<div class="grayr">
			<jsp:include page="/common/db_pager.jsp">
			  <jsp:param value="${ctx}/genscript!ApInvoiceList.action" name="moduleURL"/>
			</jsp:include>	
		</div>
	  </td>
    </tr>
