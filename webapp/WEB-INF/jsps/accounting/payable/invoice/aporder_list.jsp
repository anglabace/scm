    ...
    <table width="449" border="0" cellspacing="0" cellpadding="0" height="339">
      ...
      <tr>
        <td style="padding-left:60px;"><br />
          ...
          <tr>
            <td>
            <form method="get" target="_self" id="searchForm" action="genscript!purchaseOrderNoSearch.action">
            <table border="0" cellpadding="0" cellspacing="0" class="Customer_table">
              <tr>
                <th>Order No</th>
                <input type="hidden" name="filter_EQI_vendorNo" value="${param.filter_EQI_vendorNo }"/>
                <td><input name="filter_EQI_orderNo" id="filter_EQI_orderNo"  type="text" value="${param.filter_EQI_orderNo }" class="NFText" size="20"/></td>
              ...
              <table width="373" border="0" cellspacing="0" cellpadding="0" height="244">
                ...
                <tr>
                  <td><div  style="width:367px; height:130px; overflow:scroll;">
                    ...
                    <s:iterator value="purchaseOrderPage.result" var="orderNo">
                      <tr>
      ...
      <td>
		<div class="grayr">
			<jsp:include page="/common/db_pager.jsp">
			  <jsp:param value="${ctx}/genscript!purchaseOrderNoSearch.action" name="moduleURL"/>
			</jsp:include>	
		</div>
	  </td>
    </tr>
