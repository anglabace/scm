...
<%			
		...
		transactionIds = request.getAttribute("transactionIds").toString();
		//request.removeAttribute("transactionIds");
	}
%>

<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>delete payment transaction page</title>
...
>
						...
						<tr>
							<td style="padding-left: 20px;">
								...
								<form name="form1" id="form1" method="post" action="ar_invoice_payment!doDelete.action" target="">
