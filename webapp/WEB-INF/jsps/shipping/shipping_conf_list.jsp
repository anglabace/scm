		    ...
		    <form class="niceform">
		      <table border="0" cellpadding="0" cellspacing="0" class="General_table">
                <tr>
                  ...
                  <td><input name="textfield" type="text" class="NFText" value="${eDto.employeeName}" size="25" readonly="readonly" /></td>
                  <th width="150">Status</th>
                  <td><select name="select" style="width:157px;" id="check_1">
                    <option>${eDto.employeeId}</option>
                    <option>${eDto.employeeName}</option>
                  </select></td>
                </tr>
                <tr>
                  <th rowspan="2" valign="top">Ship to</th>
                  <td rowspan="2"><textarea name="textarea2" readonly="readonly" class="content_textarea2" >${eDto.employeeName}</textarea></td>
                  <th>Shipment Method</th>
                  <td><input id="employeeId" name="employeeId" type="text" class="NFText" value="${eDto.employeeName}" size="25" readonly="readonly" /></td>
                </tr>
                <tr>
                  <th>&nbsp;</th>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td><input name="textfield8" type="text" class="NFText" value="${eDto.employeeName}" size="25" /></td>
                  <th>Tracking No</th>
                  <td><input name="textfield6" type="text" class="NFText" value="${eDto.employeeName}" size="25" /></td>
                </tr>
                <tr>
                  <th>Shipping Clerk</th>
                  <td><input name="textfield3" type="text" class="NFText" value="${eDto.employeeName}" size="25" readonly="readonly" /></td>
                  <th>Created Date</th>
                  <td><input name="textfield5" type="text" class="NFText" value="${eDto.employeeName}" size="25" readonly="readonly" /></td>
                </tr>
                  <tr>
      <th>Modified By </th>
      <td><input name="textfield2" type="text" class="NFText" value="${eDto.employeeName}" size="25" readonly="readonly" /></td>
      <th>Modified Date</th>
      <td><input name="textfield7" type="text" class="NFText" value="${eDto.employeeName}" size="25" readonly="readonly" /></td>
    </tr>
                  <tr>
    ...
    <div class="dhtmlgoodies_aTab">
      ...
      <table width="955" border="0" cellpadding="0" cellspacing="0" class="list_table">
        ...
        <tr>
          ...
          <td width="100">2357</td>
          <td width="102">2</td>
          <td width="261">Beta Amyloid Peptides</td>
          <td width="84">&nbsp;</td>
          <td width="84">&nbsp;</td>
          <td width="104">&nbsp;</td>
...
<div class="button_box">
      ...
      <input type="submit" name="Submit124" value="Cancel" class="search_input" onclick="window.location.href='ship_conf.html'"/>
</div>
</div>	
</body>
</html>
