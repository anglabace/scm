		...
		<tr>
			<td bgcolor="#FFFFFF">
				<form id="FollowUpForm">
					<input type="hidden" name="followUp.id" value="" />
					...
					<table border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td height="30"><input type="text" size="30" class="NFText"
								readonly="readonly" value="${productiontargetDate}" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td height="30"><s:if
									test="%{followUp.status=='closed' || OpenFlag==1}">
						...
						<tr>
							...
							<td height="70"><s:if
									test="%{followUp.status=='closed'  || OpenFlag==1 }">
									<textarea name="followUp.message" class="content_textarea2" id="result"
										disabled="disabled" style="width: 325px;">${followUp.message} </textarea>
								</s:if> <s:else>
									<textarea name="followUp.message" class="content_textarea2" id="result"
										style="width: 325px;">${followUp.message} </textarea>
								</s:else>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2">
								<div class="invoice_title">Followup History:</div>
							</td>
						</tr>
					</table>
