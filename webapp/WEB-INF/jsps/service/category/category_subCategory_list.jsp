...
$(function(){
	...
	parent.$('#addPrCategoryDialog').dialog("option", "open",function(){
		var htmlStr = '<iframe id="catSubCatAdd_iframe" src="${ctx}/serv/service_category!catSubCatAdd.action?categoryLevel=${categoryLevel}&sessionCategoryId=${sessionCategoryId}&parentCatId=${parentCatId}&parentCategoryNo=${parentCategoryNo}&categoryId=${categoryId}" height="260" width="680" scrolling="no" style="border:0px" frameborder="0"></iframe>';
...
function delServSubCategory(name){
	...
	$.ajax({
		type:"POST",
		url:"serv/service_category!delSubServiceCategory.action?sessionCategoryId=${sessionCategoryId}&delSubServiceCategory="+del_category_nos,
      ...
      <table width="950" border="0" cellspacing="0" cellpadding="0" class="list_table2">
          ...
          <th width="46">
            <div align="left">
                ...
                <img src="images/file_delete.gif" alt="Delete" width="16" height="16" border="0" onclick="delServSubCategory('ctgIds');" />
            </div>
          </th>
          <th width="100">
    ...
    <tr>
      <td><div class="grayr">
				<jsp:include page="/common/db_pager.jsp">
					<jsp:param value="${ctx}/serv/service_category!subCategoryList.action?categoryLevel=${categoryLevel}" name="moduleURL"/>
				</jsp:include>
	  </div></td>
    </tr>
</table>
