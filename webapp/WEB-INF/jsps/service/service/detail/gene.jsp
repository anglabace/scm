     ...
     <div class="dhtmlgoodies_aTab">
       <table width="100%" border="0" cellpadding="0" cellspacing="0" class="General_table">
         ...
         <tr>
           ...
           <td><input name="Input" type="text" class="NFText" onkeypress="if ((event.keyCode < 48 || event.keyCode > 57) && event.keyCode != 45 && event.keyCode != 46) event.returnValue = false;"/></td>
         </tr>
         <tr>
     ...
     <div class="dhtmlgoodies_aTab">
       <table width="100%" border="0" cellspacing="0" cellpadding="0" class="General_table">
         <tr>
           ...
           <td width="80%"><input type="text" name="desc" value="" class="NFText"/></td>
         </tr>
		 <tr>
           <th width="20%">Other Requirements </th>
           <td width="80%"><textarea name="textarea3" class="content_textarea2"/></td>
         </tr>
		 <tr>
           <th width="20%">Service Detail Document </th>
           <td width="80%"><label><input type="file" name="qc_file" id="qc_file" size="55" maxlength="80" />
		   &nbsp;<input type="button" name="upload" value="Upload" class="style_botton"/></label></td>
         </tr>
       </table>
     </div>
</div>
