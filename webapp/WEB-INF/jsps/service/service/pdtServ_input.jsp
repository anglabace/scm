...
<script src="${global_js_url}scm/serv_inventory_add.js?v=5" type="text/javascript"></script>
</head>
  ...
  <tr id="">
    ...
    <td colspan="2">
	    ...
	    <span style="display:none;" id="dateSpan">
        	<input name="effFrom" id="effFrom" type="text" class="pickdate NFText" style="width:75px;" value="     -   -  " size="18"/>
        	&nbsp;&nbsp;to
	    	<input name="effTo" id="effTo" type="text" class="pickdate NFText" style="width:75px;" value="     -   -  " size="18"/>
	    </span>
	</td>
  </tr>
  <tr>
