...
function saveCross(){
	...
	$.ajax({
		type:"POST",
		url:"product/product!saveSessionCrossAct.action",
...
function catalogNoDialog(){
	...
	parent.$('#crossCtgNoSrchDialog').dialog("option", "open",function(){
		...
		var htmlStr = '<iframe src="product/product!searchStdPriceList.action?noList='+noListStr+'&type=Product" height="340" width="680" scrolling="no" style="border:0px" frameborder="0"></iframe>';
    ...
    <td><fieldset>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td>
          <input type="hidden" name="crossDetail.productId" id="productId" value="${crossDetail.productId }" />
          <input type="hidden" name="sessionProductId" id="sessionProductId" value="${sessionProductId }" />
        ...
        <tr>
          ...
          <td>
          	...
          	<input name="crossDetail.rltProductId" id="rltProductId" value="${crossDetail.rltProductId}" type="hidden" />
          </td>
        </tr>
      </table>
      </fieldset>
