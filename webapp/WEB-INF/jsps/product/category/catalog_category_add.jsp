...
$(function(){
	...
	$("#chooseCategoryDialogTrigger").click(function(){
		parent.$('#chooseCategoryDialog').dialog("option", "open",function(){
			var htmlStr = '<iframe id="chooseCategoryDialog" src="${ctx}/product/product_category!ctlgChooseCatList.action?categoryLevel=1&cataId=${cataId}&sessionCatalogId=${sessionCatalogId}" height="400" width="320" scrolling="no" style="border:0px" frameborder="0"></iframe>';
...
function saveCatCategory(){
	...
	$.ajax({
		type:"POST",
		url:"product/product_category!addProductCategoryToCatalog.action?productCategoryKey="+ctgId,
		...
		success: function(msg){
			if(msg=="success"){
				...
				var appendStr = "<tr id=del_"+ctgId+"><td width='46'>&nbsp;<input type='checkbox' value="+ctgId+" name='ctgIds'/>";
				appendStr += "</td><td width='85' style='word-break:break-all;word-wrap:break-word;width:85'>&nbsp;"+ctgNo+"</td>";
				...
				parent.$("#categoryProductList_iframe").contents().find("#pdCategoryTb").append(appendStr);
