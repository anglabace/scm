...
$(function(){
	...
	$("#addCategoryDialogTrigger").click(function(){
		parent.$('#addCategoryDialog').dialog("option", "open",function(){
			var htmlStr = '<iframe id="catalog_product_Category_iframe" src="${ctx}/product/product_category!ctlgCatAdd.action?sessionCatalogId=${sessionCatalogId}&cataId=${param['filter_EQS_catalogId']}" height="260" width="680" scrolling="no" style="border:0px" frameborder="0"></iframe>';
...
function delPdtCategory(name){
	...
	$.ajax({
		type:"POST",
		url:"product/product_category!delProductCategoryToCatalog.action?sessionCatalogId=${sessionCatalogId}&delProductCategory="+del_category_nos,
  ...
  <table width="950" border="0" cellspacing="0" cellpadding="0" class="list_table2" id="pdCategoryTb" style="table-layout:fixed;word-break:break-all">
   <s:iterator value="page.result">
     <tr id="del_${categoryId }">
      ...
      <td width="106" style="word-break:break-all;word-wrap:break-word;width:106">&nbsp;
     	${name}
      </td>
