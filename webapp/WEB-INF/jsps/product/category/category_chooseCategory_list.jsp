...
function fzCategoryNo(uId){
	...
	var pdtCategoryList = parent.$("#categoryId").val();
	...
	var obj_subCategory = parent.$("#catalog_product_Category_iframe").contents();
...
<body>
    ...
    <div class="grayr">
			<jsp:include page="/common/db_pager.jsp">
			  <jsp:param value="${ctx}/product/product_category!ctlgChooseCatList.action" name="moduleURL"/>
			</jsp:include>
		</div>
