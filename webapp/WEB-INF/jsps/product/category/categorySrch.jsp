...
$(document).ready(function(){  
    ...
    $("#saveApprovedStatusTrigger").click(function(){
        ...
        $.ajax({
			url:"product/product_category!delCategoryListApproved.action",
			type:"get",
			...
			success:function(data){
				if(hasException(data)){
					...
					window.location.href="product/product_category.action";
				}
			},
			error:function(data){
				alert("System error! Please contact system administrator for help.");
	...
	$.ajax({
		...
		success: function(msg){
			if(msg == 'success'){
				...
				alert('Fail to remove the category');
			}else {
				alert('System error! Please contact system administrator for help.');
			}
...
<form id="mainForm" action="${ctx }/product/product_category.action" method="get">
<s:if test="categoryLevel==1">
Business Unit No
</s:if>
<s:if test="categoryLevel==2">
...
<div class="input_box">
    ...
    <table width="973" border="0" cellspacing="0" cellpadding="0" class="list_table2">
        ...
        <th width="100">Business Division</th>
        <th>Modify Date </th>
        </tr>
	</table>
    </div>
  		<div class="list_box" style="height:340px; width:983px;">
    	<table width="973" border="0" cellspacing="0" cellpadding="0" class="list_table2" style="table-layout:fixed;word-break:break-all">
        	...
        	<td width="125" style='word-break:break-all;word-wrap:break-word;width:90'>
        		<a href="${ctx }/product/product_category!input.action?categoryId=${categoryId}&callBackName=categoryCreationForm&operation_method=edit&dodo=first">
        		${categoryNo}&nbsp;
        		</a>
        	</td>
        	...
        	<td width="106"><div align="left" style='word-break:break-all;word-wrap:break-word;width:106'>
        	${catalogId}
        	&nbsp;</div></td>
        	<td width="94">${assetGroup}&nbsp;</td>
        	<td width="100">${businessDivision}&nbsp;</td>
		...
		<div class="grayr">
			<jsp:include page="/common/db_pager.jsp">
			  <jsp:param value="${ctx }/product/product_category.action" name="moduleURL"/>
			</jsp:include>
	    </div>
</div>
 <div  class="button_box">
<input type="button" value="New" class="search_input" onclick="window.location.href='${ctx}/product/product_category!input.action?categoryLevel=${categoryLevel}&callBackName=categoryCreationForm&dodo=new'" />
  </div>
