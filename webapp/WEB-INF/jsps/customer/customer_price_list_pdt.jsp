...
//add/edit trigger
            $("#addPriceDialogTrigger").click(function() {
                ...
                parent.parent.$('#addCustomerSpclPrcDialog').dialog('option', "listType", "PRODUCT");
            ...
            $("#SeeCustomerSpclDialogTrigger").click(function() {
                ...
                parent.parent.$('#SeeCustomerSpclDialog').dialog('option', "listType", "PRODUCT");
...
<body>
<form method="post" action="cust_spcl_prc!delete.action" id="pdt_form">
        ...
        <tr>
            <th width="46">
                <div align="left">
                    ...
                    <img src="${global_image_url}file_delete.gif" width="16" height="16" onclick="remove('pdt_form');"/>
                </div>
            </th>
        ...
        <table width="923" border="0" cellpadding="0" cellspacing="0" class="list_table">
            ...
            <s:iterator value="priceMap" status="st">
                <tr>
                    ...
                    <td width="75">&nbsp;
                        <s:property value="sourceMap[value.source].name"/>
                    </td>
