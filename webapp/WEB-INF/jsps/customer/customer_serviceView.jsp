...
<div style="height:265px; width:740px; overflow:scroll">
    <table width="765" border="0"
        ...
        <s:iterator value="custServiceViewList.result">
            ...
            <tr align="center">
                ...
                <td width="305"${tdclass}>&nbsp;${serviceName}</td>
...
<div style="margin-left: 300px;" id="service_view_indicator"></div>
<div class="grayr" id="service_view_pane_pager">
    <jsp:include page="/common/db_pager.jsp">
        <jsp:param value="${ctx}/customer_web_behavior!getServiceViewList.action" name="moduleURL"/>
    </jsp:include>
</div>
