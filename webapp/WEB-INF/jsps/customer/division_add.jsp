...
<html xmlns="http://www.w3.org/1999/xhtml">
            ...
            $(function() {
			   ...
			   $('#div_form').validate({
					...
					invalidHandler: function(form, validator) {
					 ...
					 messages: {
						 "division.name": { required : "Please enter the division name !" }
					 },
	...
	<body style="overflow: hidden" id="input_body">
		<form method="get" id="div_form">
		    <input type="hidden" name="division.orgId" value="${param.orgId}" />
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td width="389">
						<input name="division.name" value="${division.name}" type="text" class="NFText" size="35" />
					</td>
				</tr>
				<tr>
					<th valign="top">
					...
					<td>
						<input name="division.supervisor" value="${division.supervisor}" type="text" class="NFText" size="35" />
					</td>
				</tr>
				<tr>
					<th valign="top">
				...
				<tr>
					...
					<td>
						<select name="division.activeFlag" style="width: 207px;">
							<option value="Y">
								ACTIVE
							</option>
							<option value="N">
				...
				<tr>
					...
					<td>
						<span style="display: block"> <textarea name="division.description"
