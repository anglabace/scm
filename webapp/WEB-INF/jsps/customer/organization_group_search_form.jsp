...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
            function checkForm() {
		       ...
		       $("#desc_txt").val($.trim($("#desc_txt").val()));		    
		    }
            
            $(function() {           			
                $("#new_btn").click( function() {
					window.location = 'organization!editOrgGroup.action';
                });
                $('#delReasonDlg').dialog({
            		autoOpen: false,
            		height: 200,
	...
	<body class="content" style="background-image: none;">
		<form action="organization!listOrgGroup.action" method="get"
			target="result_iframe"  onsubmit="checkForm();">
			<input name="filter_EQS_status" value="ACTIVE" type="hidden" />
			<div class="scm">
				<div class="title_content">
					<div class="title_content">
					<div style="padding-left: 20px;color: #5579A6;vertical-align:middle;"><img src="${global_url}images/arrow1.jpg" style="width:16px;height:17px;vertical-align:middle;" onclick="toggleShowMore_img(this,'search_box1');"/>Organization Groups</div>
				</div>
				</div>
					...
					<div class="single_search">
						<table border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								...
								<td width="120">
									<input name="filter_LIKES_groupCode" type="text"
								...
								<td width="120">
									<input name="filter_LIKES_description" type="text"
										class="NFText" size="20" id="desc_txt" />
								</td>
								<td width="100">
				...
				<div class="input_box"  style="height:350px;" >
					<div class="content_box">
						<iframe id="srch_workCenter_iframe" name="result_iframe"
							src="organization!listOrgGroup.action?filter_EQS_status=ACTIVE" width="100%"
