...
function update_note(op_type){
	...
	var action = 'division!saveInstruction.action';
	...
	var options = {
		...
		success:function(data) {
			...
			if (pos == 0){
				//insert
				slt.options.add(new Option(noteType+" - instr - div", note_id, false, true)); 
				...
				slt.options.add(new Option(noteType+" - instr - div", note_id, false, true), pos); 
			}
