        ...
        function add_price(bt_obj, form_name, action_name) {
            ...
            var options = {
                success:function(data) {
                    ...
                    parent.$("#SeeCustomerSpclDialog").dialog('close');
                },
                error: function() {
                    alert('error...');
                    bt_obj.value = bt_val;
...
<form id="create_price_form" action="customer/custSpclPrc/saveCustSpclPrcAct">
    ...
    <table width="500px" border="0" style="margin:15px auto;" cellpadding="0" cellspacing="0" class="General_table">
        <tr>
            ...
            <td width="150">
                <input name="custSpecialPrice.catalogNo" id="catalogNo" type="hidden" class="NFText" size="15"/>
                <input name="custSpecialPrice.name" id="name" type="text" class="NFText" size="15" readonly="readonly"
                       value="${custSpecialPrice.catalogNo}"/>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="General_table">
                        <tr>
                            ...
                            <td><input name="custSpecialPrice.minQty" type="text" class="NFText"
                                       value="${custSpecialPrice.minQty}" size="15"/></td>
                            <td align="right">Source Key</td>
                            <td>
                                <input name="custSpecialPrice.source" type="text" class="NFText"
                                       value="${custSpecialPrice.sourceKey}" size="15"/>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">Order Total</td>
                            <td><input name="custSpecialPrice.orderTotal" type="text" class="NFText2"
                                       value="${custSpecialPrice.orderTotal}" size="15"/></td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input name="custSpecialPrice.effFrom" type="text" class="NFText datepicker"
                                       value="<s:date name='custSpecialPrice.effFrom' format='yyyy-MM-dd'/>" size="15"
                                id="effFrom" readonly="readonly" />
                            </td>
                            <td align="right">End Date</td>
                            <td>
                                <input name="custSpecialPrice.effTo" type="text" class="NFText datepicker"
                                       value="<s:date name='custSpecialPrice.effTo' format='yyyy-MM-dd'/>" size="15"
                                id="effTo" readonly="readonly" />
                            </td>
                        </tr>
                    </table>
                </fieldset>
        ...
        <tr>
            <td colspan="4">
                <div align="center">
                    <%--<input type="button" value="Save" onclick="add_price(this, 'create_price_form');"/>--%>
                    <input type="button" value="Cancel"
                           onclick="javascript:parent.$('#SeeCustomerSpclDialog').dialog('close');"/>
                </div>
            </td>
        </tr>
    </table>
