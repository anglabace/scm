...
function edit_contact(bt_obj, form_name, action_name){
	...
	var options = {
		success:function(data)
		{
			...
			parent.$('#editCustomerCntctDialog').dialog('close');
		},
		error: function(){
			alert('error...');
			bt_obj.value = bt_val;
...
<body>
<form method="post" action="cust_contact!showCustCntctEditForm.action" id="edit_contact_form">
...
<table width="660" border="0"  cellpadding="0" cellspacing="0" >
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="General_table">
      <tr>
        <td width="101">Contact Source </td>
        <td>
        ...
        <td width="100"><span class="important">*</span>Contact Name </td>
        <td colspan="2">
  ...
  <tr>
   ...
   <div id="Email1" style="display:block;">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="General_table">
        <tr>
          <td width="101">E-mail Address </td>
          <td colspan="2">
        ...
        <tr>
          <td><span class="important">*</span>Subject  </td>
        ...
        <tr>
          <td valign="top">Content to Send </td>
          <td width="175px">
	...
	<div id="Phone" style="display:none;">
        ...
        <s:select name="callTimeAmPm" cssStyle="width:59px;" list="amPmList" headerKey=" " headerValue="" value="callTimeFromAPM" />
          <select name="callTmzn" style="width:350px;">
        	...
        	<s:iterator value="dropDownDTOs">
        		<option value="${id}" label="${name }" <c:if test="${allData.callTmzn == id}">selected="${id}"</c:if>>${name }</option>
        	</s:iterator>
        	</s:if>
        	</s:iterator>
          </select>
  ...
  <tr>
    <td>
        ...
        <input type="button" value="  Save  " onclick="edit_contact(this, 'edit_contact_form', 'cust_contact!save.action?contactMethod=${allData.contactMethod}&contactIdStr=${allData.contactIdStr}&sessCustNo=${sessCustNo}&sourceName=');" />
        </c:otherwise>
        </c:choose>
          <input type="hidden" value="${allData.contactId}" name="contactId" />
          <input type="button" value="Cancel" onclick="parent.$('#editCustomerCntctDialog').dialog('close');"  />
      	</div>
      </td>
  </tr>
