...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body id="input_body">
		<form method="get" id="billing_form">
			...
			<input type="hidden" name="billing.divisionId" value="${billing.divisionId}" />
					...
					<td>
						...
						<table border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<br /></th>
								<td>
									<input name="billing.accountState" value="${billing.accountState}" type="text" class="NFText" size="35" />
								<br /></td>
								<th>
									Account Country
								<br /></th>
								<td>
									<input name="billing.accountCountry" value="${billing.accountCountry}" type="text" class="NFText" size="35" />
								<br /></td>
							</tr>
							<tr>
								<th>
