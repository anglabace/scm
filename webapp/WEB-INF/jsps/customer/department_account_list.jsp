								...
								<div style="margin-right: 12px;">
									...
									<div style="width: 940px; height: 260px; overflow: scroll;">
										<table width="922" border="0" cellpadding="0" cellspacing="0"
											class="list_table">
											<s:iterator value="customerPage.result">
												<tr>
													<td width="145">
														<a href="${global_url}customer/customer!edit.action?custNo=${custNo}&operation_method=view" target="_blank">${custNo}</a>
													</td>
													<td width="97">
														${status}
													</td>
							...
							<td>
								<div class="grayr">
									<jsp:include page="/common/db_pager.jsp">
										<jsp:param value="${ctx}/department!showAccount.action"
											name="moduleURL" />
									</jsp:include>
								</div>
							</td>
