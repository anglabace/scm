...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body id="input_body">
		<form method="get" id="billing_form">
			...
			<input type="hidden" name="billing.deptId" value="${billing.deptId}" />
					...
					<td>
						<table border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<td width="385">
									<input name="billing.contactName"
										value="${billing.contactName}" type="text" class="NFText"
										size="35" />
								</td>
							</tr>
						</table>
					...
					<td>
								...
								<tr>
									...
									<td width="385">
										<s:select name="billing.creditCard"
											list="#{'EXPRESS':'American Express', 'DISCOVER':'Discover', 'MASTER':'Master', 'VISA':'VISA'}"
											cssStyle="width:207px;" value="billing.creditCard"></s:select>
									</td>
									<th width="138">
										Card Number
									</th>
									<td width="187">
										<input name="billing.number" value="${billing.number}"
								...
								<tr>
									...
									<td style="margin: 0px; padding: 0px;">
										<s:select name="billing.expMonth"
											...
											cssStyle="width:100px;" value="billing.expMonth" headerKey=" " headerValue=" " ></s:select>
										<s:select name="billing.expYear"
											list="{2011,2012,2013,2014,2015,2016,2017,2018,2019,2020}"
											cssStyle="width:102px;" value="billing.expYear"  headerKey=" " headerValue=" "></s:select>
									</td>
									<th>
										&nbsp;
									</th>
						...
						<table id="Account_Info" border="0" cellpadding="0"
							...
							<tr>
								...
								<td width="385">
									<s:select name="billing.accountUsage"
										list="#{'BOTH':'Both', 'DEBIT':'Direct Debit', 'DEPOSIT':'Direct Deposit', '':'None'}"
										cssStyle="width:207px;" value="billing.accountUsage"></s:select>
								</td>
								<th width="138">
									Bank Account Type
								</th>
							...
							<tr>
								...
								<td>
									<input name="billing.accountNo" value="${billing.accountNo}"
										type="text" class="NFText" size="35" />
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="billing.routingNo" value="${billing.routingNo}"
										type="text" class="NFText" size="35" />
								</td>
								<th>
									IBAN
								...
								<td>
									<input name="billing.iban" value="${billing.iban}" type="text"
							...
							<tr>
								...
								<td>
									<input name="billing.bban" value="${billing.bban}" type="text"
										class="NFText" size="35" />
								</td>
								<th>
									&nbsp;
						...
						<table border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<td width="385">
									<input name="billing.accountName"
										value="${billing.accountName}" type="text" class="NFText"
										size="35" />
									<br />
								</td>
								<th width="138">
								...
								<td>
									<input name="billing.accountStreet"
										value="${billing.accountStreet}" type="text" class="NFText"
										size="35" />
									<br />
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="billing.accountCity"
										value="${billing.accountCity}" type="text" class="NFText"
										size="35" />
									<br />
								</td>
								<th>
								...
								<td>
									<input name="billing.accountZip" value="${billing.accountZip}"
										type="text" class="NFText" size="35" />
									<br />
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="billing.accountState"
										value="${billing.accountState}" type="text" class="NFText"
										size="35" />
									<br />
								</td>
								<th>
								...
								<td>
									<input name="billing.accountCountry"
										value="${billing.accountCountry}" type="text" class="NFText"
										size="35" />
									<br />
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="billing.driveLicense"
										value="${billing.driveLicense}" type="text" class="NFText"
										size="35" />
									<br />
								</td>
								<th>
								...
								<td>
									<input name="billing.socialSecurityNo"
										value="${billing.socialSecurityNo}" type="text" class="NFText"
										size="35" />
									<br />
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="billing.accountEmail"
										value="${billing.accountEmail}" type="text" class="NFText"
										size="35" />
									<br />
								</td>
								<td>
							...
							<tr>
								...
								<td>
									<s:select name="billing.addressVerified"
										list="#{'NoMatch':'No Match', 'Unavailable':'Unavailable', 'Match':'Match'}"
										cssStyle="width:207px;" value="billing.addressVerified"></s:select>
									<br />
								</td>
								<td>
									&nbsp;
