...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    var GB_ROOT_DIR = "./greybox/";
	 ...
	 function selects(){ 
		...
		var len=item.length; 
	if(len>0){ 
	 	var wos =$(":radio:checked").val(); 
	  	document.forms[0].action ="work_order!workOrderSearch2.action?vendorName="+wos+"";
	} 
					...
					<td>
						...
						<div class="list_box" style="height: 340px;">
							<div id="userOfRoleDiv" name="userOfRoleDiv">
								<table width="100%" border="0" align="center" cellpadding="0"
									...
									<s:iterator value="pageVendorDTO.result">
										...
										<tr>
											<td width="20" style="height: 20px;"${tdclass}>
												<input type="radio" id="vendorName" name="vendorName"
													value="${vendorName }" />
											</td>
						...
						<div class="grayr">
							<jsp:include page="/common/db_pager.jsp">
								<jsp:param value="${ctx}/work_order!vendorManageList.action"
									name="moduleURL" />
							</jsp:include></div>
					</td>
				</tr>
