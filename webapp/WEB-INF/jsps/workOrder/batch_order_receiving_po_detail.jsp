 ...
 /////////////////////po/////////////////////////////
	...
	$('#purchaseOrderReceiving').dialog('open');
		...
		function doReset(){
			...
			document.forms[0].action="work_order!purchaseOrderReset.action?po=po2&chks="+chks;
			document.forms[0].submit();
		}
	...
	<div id="frame12" style="display: none;" class="hidlayer1">
		...
		<form action="" name="receivingForm" method="post">
			<input type="hidden" value="${receive1 }" name="receive1"
				id="receive1" />
				<input type="hidden" value="${receive2 }" name="receive2"
				id="receive2" />
			<input type="hidden" value="${trackingNo }" name="trackingNo"
				id="trackingNo" />
				
				<input type="hidden" value="${chks }" name="chks"
				id="chks" />
								...
								<td>
									<div class="grayr">
										<jsp:include page="/common/db_pager.jsp">
											<jsp:param
												value="${ctx}/work_order!getPurchaseReceivingDetail.action"
												name="moduleURL" />
										</jsp:include>
									</div>
								</td>
