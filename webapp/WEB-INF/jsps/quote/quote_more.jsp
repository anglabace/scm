...
//			tgtVectorSize:{required:true,digits:true},
	...
	$("#targetForm").validate({
		...
		messages: {
			variantSequence: {required:"Please select the 'sequence' in 'More Detail','Target Construct' tab."},
...
<div id="dhtmlgoodies_tabView1" >
	...
	<s:if test="show == 'gene'">
	     <div class="dhtmlgoodies_aTab">
	       	<s:include value="quote_more_gene.jsp"></s:include>
		 </div>
	     <div class="dhtmlgoodies_aTab">
	       <s:include value="quote_more_codon.jsp"></s:include>
	     </div>
	     <div class="dhtmlgoodies_aTab">
	       <s:include value="quote_more_cloning.jsp"></s:include>
	     </div>
	     <div class="dhtmlgoodies_aTab">
	        <s:include value="quote_more_plasmid.jsp"></s:include>
	     </div>
		 <div class="dhtmlgoodies_aTab">
	     	<s:include value="quote_more_usage.jsp"></s:include>
	     </div>
	     <div class="dhtmlgoodies_aTab">
			<s:include value="quote_more_moreinfo.jsp"></s:include>
	     </div>
     </s:if>
     <!-- *************************Cloning Strategy ************************************************************ -->
 	...
 	<div class="dhtmlgoodies_aTab">
       <s:include value="quote_more_template.jsp"></s:include>
     </div>
	<div class="dhtmlgoodies_aTab">
        <s:include value="quote_more_target.jsp"></s:include>
     </div>
     <div class="dhtmlgoodies_aTab">
        <s:include value="quote_more_cloning.jsp"></s:include>
     </div>
   ...
   <!-- ************************** ORF Clone Start *********************************************************** -->
     <s:if test="show == 'orfClone'">
	     <s:include value="quote_more_orf_clone.jsp"></s:include>
     </s:if>
     <!-- ************************** ORF Clone End *********************************************************** -->
    ...
    <!-- ************************** Oligo Start *********************************************************** -->
     <s:if test="show == 'oligo'">
	     <div class="dhtmlgoodies_aTab">
	     	<s:include value="quote_more_oligo_detail.jsp"></s:include>
	     </div>	
	     <div class="dhtmlgoodies_aTab">
	        <s:include value="quote_more_oligo_batch_orders.jsp"></s:include>
	     </div>
     </s:if>
     <!-- ************************** Oligo End *********************************************************** -->
...
<!-- ************************** Mutation Libraries Start *********************************************************** -->
     <s:if test="show == 'mutaLib'">
	     <div class="dhtmlgoodies_aTab">
	     	<s:include value="quote_more_muta_lib.jsp"></s:include>
	     </div>
	     <div class="dhtmlgoodies_aTab">
       		<s:include value="quote_more_template.jsp"></s:include>
	     </div>
...
<!-- ************************** Mutation Libraries End *********************************************************** -->
     ...
     <s:if test="show == 'sequencing'">
	     	<s:include value="quote_more_sequencing.jsp"></s:include>
     </s:if>
     <!-- ************************** Sequencing End *********************************************************** -->
     ...
     <s:if test="show == 'customService'">
	     	<s:include value="quote_more_custom_service.jsp"></s:include>
     </s:if>
     <!-- ************************** Custom Service End *********************************************************** -->
     
<!-- **************************Peptide *********************************************************** -->
 <s:if test="show == 'peptide' || show == 'librayPeptide' || show == 'arrayPeptide'">
 	<s:include value="quote_more_peptide.jsp"></s:include>
 </s:if>
 <!-- **************************Rna *********************************************************** -->
  <s:if test="show == 'rna'">
	     <div class="dhtmlgoodies_aTab">
	       	<s:include value="quote_more_rna.jsp"></s:include>
		 </div>
	     <div class="dhtmlgoodies_aTab">
	        <s:include value="quote_more_plasmid.jsp"></s:include>
	     </div>
 ...
 <s:if test="show == 'pro'">
 	<s:include value="quote_more_pkg.jsp"></s:include>
 </s:if>
 <!-- **************************Protein&Bioprocess&Pharmeceutical&Antibody drug sub...*********************************************************** -->
 <s:if test="show == 'prosub'">
 	<s:include value="quote_more_pkg_sub.jsp"></s:include>
 </s:if>
 
 <!-- **************************antibody.*********************************************************************************************************** -->
 <s:if test="show == 'antibody'">
	<s:include value="quote_more_antibody.jsp"></s:include>
</s:if>
...
function init(showType){
	...
	if(show == "gene"){
		...
		initTabs('dhtmlgoodies_tabView1',Array('Standard Peptide','Batch Order'),0,965,500);
	}else if(show == "librayPeptide"){
		initTabs('dhtmlgoodies_tabView1',Array('Standard Peptide','Batch Order','Peptide Library'),0,965,500);
		deleteTab('Standard Peptide');
		deleteTab('Batch Order');
	}else if(show == "arrayPeptide"){
		initTabs('dhtmlgoodies_tabView1',Array('Standard Peptide','Batch Order','Peptide Library','Peptide Array'),0,965,500);
		deleteTab('Standard Peptide');
		deleteTab('Batch Order');
