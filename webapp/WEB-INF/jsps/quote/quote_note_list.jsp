...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Quote Instruction Management</title>
	...
	<body>
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td>
				<s:if test="tempStatusStr == 'CO'||tempStatusStr == 'CW'||tempStatusStr == 'VD'">
				<input type="button" id="searchInstructionBtn" class="style_botton" value="Search" disabled/> 
				</s:if>
				<s:else>
				...
				<td>
				<s:if test="tempStatusStr == 'CO'||tempStatusStr == 'CW'||tempStatusStr == 'VD'">
				<input type="button" id="instructionDialogBtn" value="Add" class="style_botton"  disabled/> 
				</s:if>
				<s:else>
		...
		<div id="tb1" style="display: block;">
			<table width="960" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<c:if
						test="${searchNoteType=='SALES_NOTES' or searchNoteType=='SHIPMENT' or searchNoteType=='PRODUCTION' or searchNoteType=='ACCOUNTING' or searchNoteType=='FOLLOWUP_DATE' or searchNoteType=='CROSS_SELLING'}">
						<th width="80">
							Source
						</th>
					</c:if>
					<s:if test="searchNoteType!=null&&searchNoteType!=''&&searchNoteType !='FOLLOWUP_EMAIL'">
						<th width="65">
							Status
						</th>
					</s:if>
			...
			<script type="text/javascript">
				$(document).ready(function(){
					...
					$("#searchInstructionBtn").click(function() {
						...
						var srcURL = "quote_note!list.action?sessQuoteNo=${sessQuoteNo}";
						window.location = srcURL + "&searchNoteType="+search_type+"&custNo=${custNo}";
					});
