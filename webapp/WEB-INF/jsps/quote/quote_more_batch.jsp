...
var itemNum = 0;
var batchUrlObj = {
    geneSynSaveUrl : "quote_more!saveGeneSynthesis.action",
    searchEnzymeUrl : "qu_order_more!searchEnzyme.action",
    custCloningSaveUrl : "quote_more!saveCustCloning.action",
    createItemUrl : "quote_item!saveBatchSessionItem.action",
    batchSaveUrl : "quote_more!saveBatchGeneSynthesis.action",
    itemList : "quote_item!list.action",
    batchCustNo : "${batchCustNo}",
    sessNO : orderquoteObj.sessNoValue
}
...
<body>
     ...
     <form id="geneSynthesisForm" method="post">
         <table width="100%" border="0" cellpadding="0" cellspacing="0" class="General_table">
             <tr>
            <td colspan="5"> 1.Enter  sequences in multiple FASTA txt format (or from excel file, the first  column is name, the second column id sequence) as shown in example below, can include restriction sites  and stop codon if needed. <br/>
              2.Only  DNA sequences can be entered, error message will be given for characters other  than A, T, C or G. <br/>
              3.Extra  5' or 3' sequence can be entered in “5' sequence” and “3' sequence” field, and will be added to all sequences. <br/>
              4.In  the subcloning interface, a discount rate can be entered. The system will calculate  the subcloning price for each gene based on size, and then apply the discount  rate to subcloning price.<br/>
              5.If  direct cloning option is checked, no subcloning item will be generated; the  gene will be put into the destination vector directly. <br/>
              6.All gene sequences are subject to  analysis after they are entered, for non-complex genes, the default price gene  synthesis will be set by the system. For complicated genes, price will be set  as TBD, account manager have to analyze these genes manually and set price.<br/><br/>
            </td>
          </tr>
         </table>
         <table width="100%" border="0" cellpadding="0" cellspacing="0" class="General_table">
             ...
             <tr>
                 <th width="100px">Plasmid Preparation</th>
                 <td colspan="4">
