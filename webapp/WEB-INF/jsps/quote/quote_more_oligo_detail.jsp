...
<table width="100%" border="0"  cellpadding="0" cellspacing="0" class="General_table" style="margin-bottom:0px;">
   ...
   <tr>
     ...
     <td>
     	<select name="backbone" id="backbone" style="width:157px">
	     	<s:if test="quoteItem.catalogNo == 'SC1516'"><option value="DNA">DNA</option></s:if>
	     	<s:elseif test="quoteItem.catalogNo == 'SC1517'"><option value="Phosphorothioated DNA">Phosphorothioated DNA</option></s:elseif>
	     	<s:elseif test="quoteItem.catalogNo == 'SC1518'"><option value="RNA">RNA</option></s:elseif>
	     	<s:elseif test="quoteItem.catalogNo == 'SC1519'"><option value="Phosphorothioated RNA">Phosphorothioated RNA</option></s:elseif>
	     	<s:elseif test="quoteItem.catalogNo == 'SC1527'"><option value="2'-OMe-RNA">2'-OMe-RNA</option></s:elseif>
	     	<s:elseif test="quoteItem.catalogNo == 'SC1528'"><option value="Phosphorothioated 2'-OMe-RNA">Phosphorothioated 2'-OMe-RNA</option></s:elseif>
     	</select>
     </td>
     <th>&nbsp;</th>
   ...
   <tr>
     ...
     <td colspan="2"><textarea id="sequence" name="sequence" class="content_textarea2"></textarea> 3'</td>
   	 <td>Sequence Length&nbsp;&nbsp;
     	<s:if test="quoteItem.oligo != null && quoteItem.oligo.seqLength != null">
     		<input id="seqLength" type="text" class="NFText" size="25" value="${quoteItem.oligo.seqLength}" disabled="disabled"/>
     	</s:if>
     	<s:else>
