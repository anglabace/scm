...
custMySearch.getMySearch('my_search!mySearchList.action?searchType=PurchaseOrderSearch');
...
function saveAdvcSrch(searchtableid, searchname){
	...
	$.ajax({
		type: "POST",
		url: "my_search!saveMysrch.action?searchType=PurchaseOrderSearch",
...
function saveMySrch(searchtableid, searchname)
{
	...
	$.ajax({
		type: "POST",
		url: "my_search!saveMysrch.action?searchType=PurchaseOrderSearch&mySrchName="+realSearchname,
		data: $('#'+searchtableid).serialize(),
		success: function(msg){
			//refresh my search drop down list
...
function openSearchDlg() {
	$('#vendor_search_dlg').dialog("option", "open", function() {	
         var htmlStr = '<iframe src="vendor_picker.action" height="450" width="620" scrolling="no" style="border:0px" frameborder="0"></iframe>';
...
<div class="title_content">
  <div class="title">US Purchase Orders</div>
</div>
...
<div class="search_box">
  <div id="TabbedPanels1" class="TabbedPanels">
    ...
    <div class="TabbedPanelsContentGroup">
      ...
      <form method="get" action="cust_processing_srch.action" target="srchCustAct_iframe" id="searchForm">
	<input type="hidden" name="search_type" value="search" />
	<input type="hidden" name="searchType" value="PurchaseOrderSearch" id="searchType" />
        <!-- <table border="0" >
          <tr>
        ...
        <table width="886"  border="0" cellpadding="0" cellspacing="0" class="General_table">
          <tr>
            ...
            <td><input name="filter_EQS_vendorName" id="filter_EQS_vendorName" type="text" class="NFText" size="18"/><a href="javascript:void(0);" onclick="openSearchDlg();"><img
	...
	<table width="725"><tr><th>
      ...
      <form method="post" id="advancedSearchForm" action="cust_processing_srch.action" _action="cust_processing_srch.action" target="srchCustAct_iframe">
	...
	<table width="725"><tr><th>
      ...
      <div style="display:none" class="TabbedPanelsContent">
      <form method="post" id="mySearchForm" action="cust_processing_srch.action" _action="cust_processing_srch.action" target="srchCustAct_iframe">
		...
		<div class="input_box">
		  <div class="content_box">
			<iframe id="srchCustAct_iframe" name="srchCustAct_iframe" src="purchase/cust_processing_srch.action?searchType=PurchaseOrderSearch" width="100%" height="630" frameborder="0" scrolling="no" ></iframe>
		</div>
  </div>	
</div>
