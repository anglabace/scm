			...
			//验证form的逻辑
			   $('#createPurchaseOrder_form').validate({
					...
					invalidHandler: function(form, validator) {
					 ...
					 messages: {
						 "warehouseId": { required : "Please enter the warehouseId !" },
						 "currency": { required : "Please enter the currency code !" },
						 "vendorName": { required : "Please enter the vendor name !" }
              ...
              $("#save_btn").click (function() {
                 ...
                 $.ajax({
						type: "POST",
						url: "cust_purchase_order!save.action",
						data: formStr,
						dataType: 'json',
...
<body>
 ...
 <form method="get" id="createPurchaseOrder_form">
  ...
  <tr>
  <input type="hidden" name="vendorNo" id="vendorNo" type="text" class="NFText"/>
    <th>Priority</th>
    ...
    <td>
						...
						/> 
							<input type="button" name="Submit2" value="Cancel"
								class="style_botton"
								onclick="parent.$('#purchaseOrderDialog').dialog('close');" />
						</div>
					</td>
    </tr>
   </table>
