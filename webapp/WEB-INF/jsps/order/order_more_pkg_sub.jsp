...
<form id="pkgSubForm" method="post">
	...
	<div class="extend_new">
		<div class="extend_line">
			<div class="extend" style="display:block;">
				...
				<div class="extend_r">
					<div class="extnd_rt">${orderItem.catalogNo}: <span class="css_blue_b">${orderItem.name}</span></div>
				</div>
			</div>
			
			<div id="exce" class="extnd_an" style="display:block;" name="contentPkgSerDiv" catalogNo="${orderItem.catalogNo}">
				<div class="extnd_ant">
				    ...
				    <s:else>
				    	<option cost="0" price="0" seqFlag="N" description="" value="${orderItem.name}">${orderItem.name}</option>
				    </s:else>
					...
					<input type="button" value="Add" class="style_botton" name="addSerPkgBtn" parentId="${orderItem.parentId}"
					itemId="${itemId}" stepListId="subStepList" descriptionId="description" catalogNo="${orderItem.catalogNo}" itemName="${item}">
				</div>
				<div class="extnd_ant">
