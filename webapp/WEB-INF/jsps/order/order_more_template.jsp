    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="General_table">
         ...
         <tr>
           <th><span class="important">*</span> Resistance</th>
           		<td>
           			<s:select name="tmplResistance" id="tmplResistance" list="dropDownMap['VECTOR_RESISTANCE']" listKey="value" listValue="value" headerKey="" headerValue=""></s:select>
        ...
        <s:if test='orderItem.clsId == "9" && (orderItem.parentId == null || orderItem.parentId == "")'>
         <tr>
           <td colspan="2" align="center">
                <input type="hidden" id="cloneCatalogNo" value="${orderItem.catalogNo}" />
