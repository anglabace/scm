...
<input type="hidden" id="prmtCode" value="${order.orderPromotion.prmtCode}" />
<input type="hidden" id="sessOrderNo" value="${sessOrderNo}" />
		...
		<s:iterator value="itemListResultMap" status="itemStatus">
         ...
         <s:else>
           ...
           <td width="65">
            ...
            <input name="custType" type="hidden" value="${order.custType}"/>
           ...
           <td width="250">
            <div name="tdNameShort" title='${value.nameShow}'>
            	<s:if test="value.nameShow != null && value.nameShow.length()>40">
