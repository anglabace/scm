...
<form id="stdPeptideForm"><input type="hidden" name="itemId" />
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<td width="29%"><s:select cssStyle="width:157px" name="quantity"
	...
	<tr>
		...
		<td><s:select cssStyle="width:157px" name="purity"
			list="specDropDownMap['PEPTIDE_PURITY'].dropDownDTOs" listKey="name"
			listValue="name"></s:select></td>
		<th>Sequence Length</th>
		<td><input name="seqLength" type="text" class="NFText" size="25" disabled="disabled"/></td>
	</tr>
	<tr>
		<th><span class="important">*</span>Sequence</th>
		<td colspan="3"><textarea name="sequence" id="stSequence"
			...
			id="sequenceSelectTrigger" class="style_botton" value="Select" /> <input
			id="sequenceValidateTrigger" type="button" class="style_botton"
			value="Validate" /><span id="warnSeqCheck"></span></td>
	</tr>
	<tr>
		<th>&nbsp;</th>
		<td colspan="3">Convert all amino acids in the sequence to
		D-amino acids? <s:radio name="aminoChangeFlag"
			list="#{'Y':'Yes','N':'No'}" value="aminoChangeFlag"></s:radio></td>
	</tr>
	<tr>
		...
		<td><s:select cssStyle="width:157px" name="nTerminal"
			...
			listValue="name" headerKey="" headerValue="No N-Terminal Modification"></s:select></td>
		...
		<td><s:select cssStyle="width:157px" name="cTerminal"
			...
			listValue="name" headerKey="" headerValue="No C-Terminal Modification"></s:select></td>
	</tr>
	<tr>
		...
		<td><s:select cssStyle="width:157px"
			...
			class="style_botton2" value="View/Modify" /></td>
		<th>Aliquoting to</th>
	...
	<tr>
		<th>Comment</th>
		<td colspan="3"><input name="comments" type="text" class="NFText"
			size="80" /></td>
	</tr>
</table>
...
<table class="General_table" border="0" cellpadding="0" cellspacing="0" height="180px;">
		...
		<ul id="modificationContainer1">
			<s:iterator value="modificationList" status="dex">
				...
				<li><input type="checkbox" name="modificationList"
					...
					value="modificationList.get(#index)" /></li>
			</s:iterator>
		</ul>
		</td>
	</tr>
	...
	<div align="center">
	<input type="button"
		name="modificationsSaveTrigger1" id="modificationsSaveTrigger1"
		class="style_botton" value="Modify" /> <input type="button"
		name="close" value="Cancel" class="style_botton"
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<th width="23%">Quantity</th>
		<td width="29%"><s:select cssStyle="width:157px" name="quantity"
			list="specDropDownMap['PEPTIDE_QUANTITY'].dropDownDTOs" listKey="name"
			listValue="name"></s:select></td>
	</tr>
	<tr>
		<th>Aliquoting to</th>
	...
	<tr>
		<td height="40" colspan="4" align="center" valign="bottom"><input id="batchPeptideCreateTrigger"
			name="batchPeptideCreateTrigger" type="button" class="style_botton" value="Create" /></td>
	</tr>
</table>
...
<div align="center"><input type="button"
			name="modificationsSaveTrigger2" id="modificationsSaveTrigger2"
			class="style_botton" value="Modify" /> <input type="button"
			name="close" value="Cancel" class="style_botton"
			onclick="$('#modificationDlg2').dialog('close');" /></div>
</div>
</form>
</div>
...
<!--
	...
	<tr>
		...
		<th width="23%">Quantity</th>
		<td width="29%">
			<s:select cssStyle="width:157px" name="peptide.quantity" list="dropDownMap['PEPTIDE_QUANTITY']" listKey="value" listValue="value"></s:select></td>
	</tr>
	<tr>
		<th>Purity</th>
		<td>
			<s:select cssStyle="width:157px" name="peptide.purity" list="dropDownMap['PEPTIDE_PURITY']" listKey="value" listValue="value"></s:select></td>
		<th>Modification</th>
		<td><s:select cssStyle="width:157px"
			name="peptide.modification"
			list="dropDownMap['PEPTIDE_LIB_MOD']" listKey="value"
			listValue="value" headerKey="" headerValue=""></s:select></td>
	</tr>
	<tr>
		<th>QC Report</th>
	...
	<tr>
		<th>Sequence</th>
		<td colspan="3"><textarea name="peptide.sequence" id="libSequence"
			class="content_textarea2"></textarea> <span style="color:#900; padding-bottom:1px; border-bottom:1px dotted #900; cursor:pointer;margin-top:50px;"
			onmouseover="tooltip.show('Each line can contain only one peptide sequence. The maximum 500 sequences can be entered. ');" onmouseout="tooltip.hide();">
			<img src="images/qa.jpg" width="12" height="12" /></span></td>
	</tr>
	<tr>
		<th valign="top">Sequence Document</th>
		<td colspan="3"><label> <input type="file"
			name="upload" id="libPeptideFile" /> (.xls, .xlsx, .txt, .csv)</label></td>
	</tr>
	<tr>
		<th>Comment</th>
		<td colspan="3"><input name="peptide.comments" type="text"
			class="NFText" size="80" /></td>
	</tr>
	<tr>
		<td height="86" colspan="4" align="center" valign="bottom"><input
			id="libPeptideCreateTrigger" type="button" class="style_botton" value="Create" /> <input
			id="libPeptideUpdateTrigger" type="button" class="style_botton" value="Update" /></td>
	</tr>
</table>
</form>
</div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<td><s:select cssStyle="width:157px" name="peptide.purity"
			list="specDropDownMap['PEPTIDE_PURITY_ARRAY'].dropDownDTOs" listKey="name"
			listValue="name"></s:select></td>
		<th>Modification</th>
		<td><s:select cssStyle="width:157px"
			name="peptide.modification"
	...
	<tr>
		...
		<td><s:select cssStyle="width:157px" name="peptide.synMembrane" list="dropDownMap['PEPTIDE_SYNTHESIS_MEMBRANE']" listKey="value" listValue="value"></s:select></td>
	</tr>
	<tr>
		<th>Delivert Format</th>
		<td><s:select cssStyle="width:157px" name="peptide.deliveryFormat" list="dropDownMap['PEPTIDE_DELIVERY_FORMAT']" listKey="value" listValue="value"></s:select></td>
		<th>&nbsp;</th>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<th>Sequence</th>
		<td colspan="3"><textarea name="peptide.sequence" id="arraySequence"
			class="content_textarea2"></textarea> <span style="color:#900; padding-bottom:1px; border-bottom:1px dotted #900; cursor:pointer;margin-top:50px;"
			onmouseover="tooltip.show('Each line can contain only one peptide sequence. The maximum 500 sequences can be entered. ');" onmouseout="tooltip.hide();">
			<img src="images/qa.jpg" width="12" height="12" /></span></td>
	</tr>
	<tr>
		<th valign="top">Sequence Document</th>
		<td colspan="3"><label> <input type="file"
			name="upload" id="arrayPeptideFile" /> (.xls, .xlsx, .txt, .csv)</label></td>
	</tr>
	<tr>
		<th>Comment</th>
		<td colspan="3"><input name="peptide.comments" type="text"
	...
	<tr>
		<td height="42" colspan="4" align="center" valign="bottom"><input id="arrayPeptideCreateTrigger"
			name="arrayPeptideCreateTrigger" type="button" class="style_botton" value="Create" /> <input
			id="arrayPeptideUpdateTrigger" type="button" class="style_botton" value="Update" /></td>
	</tr>
</table>
</form>
</div>
...
/********************** set other modification of add/remove event *****************************/
	$('#modificationsAddTrigger1')
		.click(function(){
			var modificationSel = $('#stdPeptideForm').find("[id='modification']").get(0);
			var modificationOpt = modificationSel.options[modificationSel.selectedIndex];
			var newModification = '<li><input  type="checkbox" value="' + modificationOpt.text + '" name="modificationList" checked="true"/>'+ modificationOpt.text +'</li>';
			if(modificationOpt.value == '')	return;
			...
			if(existFlag === false)
				$('#modificationContainer1').append(newModification);
			else
			...
			$('#modifications1').val(modificationStr.substring(0, modificationStr.length-1));
			//alert($('#modifications1').val());
		});
	
	$('#modificationsAddTrigger2')
	.click(function(){
		var modificationSel = $('#batchPeptideForm').find("[id='modification']").get(0);
		var modificationOpt = modificationSel.options[modificationSel.selectedIndex];
		var newModification = '<li><input  type="checkbox" value="' + modificationOpt.text + '" name="modificationList" checked="true"/>'+ modificationOpt.text +'</li>';
		if(modificationOpt.value == '')	return;
		...
		if(existFlag === false)
			$('#modificationContainer2').append(newModification);
		else
			alert("The Modification is duplicated.");
		var modificationStr="";
		$('#modificationContainer2 :input').each(function(){
		...
		$('#modifications2').val(modificationStr.substring(0, modificationStr.length-1));
		//alert($('#modifications2').val());
	});
	
	$('#modificationsViewTrigger1')
		.click(function(){
	...
	$('#libPeptideCreateTrigger')
	.click(function(){
		var refType = getRefType("libraryPeptide", 0);
		saveLibraryPeptide(itemId, "libraryPeptide", "libraryPeptideForm", refType);
		//saveLibraryPeptide();
	});
	$('#arrayPeptideCreateTrigger')
	.click(function(){
		var refType = getRefType("arrayPeptide", 0);
		saveArrayPeptide(itemId, "arrayPeptide", "arrayPeptideForm", refType);
	});

	$('#libPeptideUpdateTrigger')
	.click(function(){
		var refType = getRefType("libraryPeptide", 0);
		emptyPeptide(itemId);
		updateLibraryPeptide(itemId, "libraryPeptide", "libraryPeptideForm", refType);
	});
	$('#arrayPeptideUpdateTrigger')
	.click(function(){
		var refType = getRefType("arrayPeptide", 0);
		emptyPeptide(itemId);
		updateArrayPeptide(itemId, "arrayPeptide", "arrayPeptideForm", refType);
	});
