...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="General_table">
         ...
         <tr>
           ...
           <td colspan="3"><input name="tgtCloningMethod" type="radio" checked="checked" value="Standard" disabled/>
	             Cloning site :
	             <input name="tgtCloningSite" type="text" class="NFText" size="25" disabled/>(Example:BamHI-HindIII) <input name="tgtCloningMethod" type="radio" value="Gateway" disabled/>Gateway <sup>TM</sup>
			</td>
         </tr>
    <tr>
        <th></th>
...
var cloningUrlObj = {
    saveBatchCloning : "order_more!saveCustCloning.action",
    cloningParentId : "<%=itemIds%>",
    cloningSessNo : "${sessOrderNo}",
    itemId : "<%=itemIds%>",
