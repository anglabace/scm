         ...
         <table width="960" border="0" cellpadding="0" cellspacing="0" class="list_table" id="packageList">
	         <s:iterator value="packageMap" status="pm">
	           <tr>
	             ...
	             <td width="64">&nbsp;
	             	<span packageId="${key}" id="packageIdLink" style="color:#0066CC;cursor: pointer" mce_style="cursor: pointer" title="Package <s:property value='#pm.index+1'/> Information">
	             ...
	             <td width="120" title="${value.shiptoAddress}">
		             ...
		             <s:else>&nbsp;${value.shiptoAddress}</s:else>
	             </td>
