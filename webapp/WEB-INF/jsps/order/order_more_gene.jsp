...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="General_table">
         ...
         <tr>
           <th>Seq Length</th>
           <td colspan="2">
           <s:if test="orderItem.geneSynthesis.seqLength != null">
           		<input id="seqLength" class="NFText" size="25" type="text" value="${orderItem.geneSynthesis.seqLength}" disabled="disabled">
           </s:if>	
           <s:else>
         ...
         <tr>
           <td colspan="5" align="center">
                <input type="hidden" id="geneCatalogNo" value="${orderItem.catalogNo}" />
                <s:if test="orderItem.clsId == 3 || orderItem.clsId == 9">
